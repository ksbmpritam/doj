...
# Voucher
Route::get('admin/voucher', [App\Http\Controllers\Admin\VoucherController::class, 'index'])->name('admin.voucher');
Route::get('admin/voucher/create', [App\Http\Controllers\Admin\VoucherController::class, 'create'])->name('admin.voucher.create');
Route::post('admin/voucher/insert', [App\Http\Controllers\Admin\VoucherController::class, 'insert'])->name('admin.voucher.insert');
Route::get('admin/voucher/edit/{id}', [App\Http\Controllers\Admin\VoucherController::class, 'edit'])->name('admin.voucher.edit');
Route::post('admin/voucher/update/{id}', [App\Http\Controllers\Admin\VoucherController::class, 'update'])->name('admin.voucher.update');
Route::get('admin/voucher/delete/{id}', [App\Http\Controllers\Admin\VoucherController::class, 'destroy'])->name('admin.voucher.destory');

# Safety And Emergency
Route::get('admin/safety', [App\Http\Controllers\Admin\SafetyController::class, 'index'])->name('admin.safety');
Route::get('admin/safety/create', [App\Http\Controllers\Admin\SafetyController::class, 'create'])->name('admin.safety.create');
Route::post('admin/safety/insert', [App\Http\Controllers\Admin\SafetyController::class, 'insert'])->name('admin.safety.insert');
Route::get('admin/safety/edit/{id}', [App\Http\Controllers\Admin\SafetyController::class, 'edit'])->name('admin.safety.edit');
Route::post('admin/safety/update/{id}', [App\Http\Controllers\Admin\SafetyController::class, 'update'])->name('admin.safety.update');
Route::get('admin/safety/delete/{id}', [App\Http\Controllers\Admin\SafetyController::class, 'destroy'])->name('admin.safety.destory');

# Cover Image
Route::get('admin/cover_image', [App\Http\Controllers\Admin\CoverImageController::class, 'index'])->name('admin.cover_image');
Route::get('admin/cover_image/create', [App\Http\Controllers\Admin\CoverImageController::class, 'create'])->name('admin.cover_image.create');
Route::post('admin/cover_image/insert', [App\Http\Controllers\Admin\CoverImageController::class, 'insert'])->name('admin.cover_image.insert');
Route::get('admin/cover_image/edit/{id}', [App\Http\Controllers\Admin\CoverImageController::class, 'edit'])->name('admin.cover_image.edit');
Route::post('admin/cover_image/update/{id}', [App\Http\Controllers\Admin\CoverImageController::class, 'update'])->name('admin.cover_image.update');
Route::get('admin/cover_image/delete/{id}', [App\Http\Controllers\Admin\CoverImageController::class, 'destroy'])->name('admin.cover_image.destory');

// Zone
Route::get('admin/zone', [App\Http\Controllers\Admin\AdminZoneController::class, 'index'])->name('admin.zone');
Route::get('admin/zone/create', [App\Http\Controllers\Admin\AdminZoneController::class, 'create'])->name('admin.zone.create');
Route::post('admin/zone/insert', [App\Http\Controllers\Admin\AdminZoneController::class, 'insert'])->name('admin.zone.insert');
Route::get('admin/zone/edit/{id}', [App\Http\Controllers\Admin\AdminZoneController::class, 'edit'])->name('admin.zone.edit');
Route::post('admin/zone/update', [App\Http\Controllers\Admin\AdminZoneController::class, 'update'])->name('admin.zone.update');
Route::get('admin/zone/delete/{id}', [App\Http\Controllers\Admin\AdminZoneController::class, 'destroy'])->name('admin.zone.destroy');
...
// ProductsOffer
Route::get('admin/products/offer', [App\Http\Controllers\Admin\ProductsOffer::class, 'index'])->name('admin.products.offer');
Route::get('admin/products/offer/edit/{id}', [App\Http\Controllers\Admin\ProductsOffer::class, 'edit'])->name('admin.products.offer.edit');
Route::get('admin/products/offer/create', [App\Http\Controllers\Admin\ProductsOffer::class, 'create'])->name('admin.products.offer.create');
Route::post('admin/products/offer/insert', [App\Http\Controllers\Admin\ProductsOffer::class, 'insert'])->name('admin.products.offer.insert');
Route::post('admin/products/offer/update/{id}', [App\Http\Controllers\Admin\ProductsOffer::class, 'update'])->name('admin.products.offer.update');
Route::get('admin/products/offer/delete/{id}', [App\Http\Controllers\Admin\ProductsOffer::class, 'destroy'])->name('admin.products.offer.destory');
Route::get('admin/products/offer/get_product/{id}', [App\Http\Controllers\Admin\ProductsOffer::class, 'get_product'])->name('admin.products.offer.get_product');


// Today Special
Route::get('admin/today/special', [App\Http\Controllers\Admin\TodaySpecialController::class, 'index'])->name('admin.today.special');
Route::get('admin/today/special/edit/{id}', [App\Http\Controllers\Admin\TodaySpecialController::class, 'edit'])->name('admin.today.special.edit');
Route::get('admin/today/special/create', [App\Http\Controllers\Admin\TodaySpecialController::class, 'create'])->name('admin.today.special.create');
Route::post('admin/today/special/insert', [App\Http\Controllers\Admin\TodaySpecialController::class, 'insert'])->name('admin.today.special.insert');
Route::post('admin/today/special/update/{id}', [App\Http\Controllers\Admin\TodaySpecialController::class, 'update'])->name('admin.today.special.update');
Route::get('admin/today/special/delete/{id}', [App\Http\Controllers\Admin\TodaySpecialController::class, 'destroy'])->name('admin.today.special.destory');


// User Offer
Route::get('admin/users/offer', [App\Http\Controllers\Admin\UserOffers::class, 'index'])->name('admin.users.offer');
Route::get('admin/users/offer/edit/{id}', [App\Http\Controllers\Admin\UserOffers::class, 'edit'])->name('admin.users.offer.edit');
Route::get('admin/users/offer/create', [App\Http\Controllers\Admin\UserOffers::class, 'create'])->name('admin.users.offer.create');
Route::post('admin/users/offer/insert', [App\Http\Controllers\Admin\UserOffers::class, 'insert'])->name('admin.users.offer.insert');
Route::post('admin/users/offer/update/{id}', [App\Http\Controllers\Admin\UserOffers::class, 'update'])->name('admin.users.offer.update');
Route::get('admin/users/offer/delete/{id}', [App\Http\Controllers\Admin\UserOffers::class, 'destroy'])->name('admin.users.offer.destory');
...
Route::get('admin/commission', [App\Http\Controllers\Admin\CommissionController::class, 'index'])->name('admin.commission');
Route::get('admin/commission/edit/{id}', [App\Http\Controllers\Admin\CommissionController::class, 'edit'])->name('admin.commission.edit');
Route::get('admin/commission/create', [App\Http\Controllers\Admin\CommissionController::class, 'create'])->name('admin.commission.create');
Route::post('admin/commission/insert', [App\Http\Controllers\Admin\CommissionController::class, 'insert'])->name('admin.commission.insert');
Route::put('admin/commission/update/{id}', [App\Http\Controllers\Admin\CommissionController::class, 'update'])->name('admin.commission.update');
Route::get('admin/commission/delete/{id}', [App\Http\Controllers\Admin\CommissionController::class, 'destory'])->name('admin.commission.destory');
...
Route::get('admin/users/profile', [App\Http\Controllers\Admin\UserController::class, 'profile'])->name('admin.users.profile');
Route::put('admin/users/profile/update/{id}', [App\Http\Controllers\Admin\UserController::class, 'updateprofile'])->name('admin.users.profile.update');
Route::get('admin/users/password', [App\Http\Controllers\Admin\UserController::class, 'password'])->name('admin.users.password');
Route::put('admin/users/password/update/{id}', [App\Http\Controllers\Admin\UserController::class, 'updatepassword'])->name('admin.users.password.update');
...
//FAQ
Route::get('admin/faq', [App\Http\Controllers\Admin\FaqController::class, 'index'])->name('admin.faq');
Route::get('admin/faq/create', [App\Http\Controllers\Admin\FaqController::class, 'create'])->name('admin.faq.create');
Route::post('admin/faq/insert', [App\Http\Controllers\Admin\FaqController::class, 'insert'])->name('admin.faq.insert');
Route::get('admin/faq/edit/{id}', [App\Http\Controllers\Admin\FaqController::class, 'edit'])->name('admin.faq.edit');
Route::post('admin/faq/update/{id}',[App\Http\Controllers\Admin\FaqController::class, 'update'])->name('admin.faq.update');
Route::get('admin/faq/delete/{id}',[App\Http\Controllers\Admin\FaqController::class, 'delete'])->name('admin.faq.delete');
...
# Resturant Withdrawal Request
Route::get('admin/resturant/withdrawal/request', [App\Http\Controllers\Admin\ResturantWithdrawalRequestController::class, 'index'])->name('admin.resturant.withdrawal.request');
Route::get('admin/resturant/withdrawal/edit/{id}', [App\Http\Controllers\Admin\ResturantWithdrawalRequestController::class, 'edit'])->name('admin.resturant.withdrawal.edit');
Route::post('admin/resturant/withdrawal/update/{id}',[App\Http\Controllers\Admin\ResturantWithdrawalRequestController::class, 'update'])->name('admin.resturant.withdrawal.update');

# Customer Withdrawal Request
Route::get('admin/user/withdrawal/request', [App\Http\Controllers\Admin\UserWithdrawalRequestController::class, 'index'])->name('admin.user.withdrawal.request');
Route::get('admin/user/withdrawal/edit/{id}', [App\Http\Controllers\Admin\UserWithdrawalRequestController::class, 'edit'])->name('admin.user.withdrawal.edit');
Route::post('admin/user/withdrawal/update/{id}',[App\Http\Controllers\Admin\UserWithdrawalRequestController::class, 'update'])->name('admin.user.withdrawal.update');

# Customer Rating
Route::get('admin/rating', [App\Http\Controllers\Admin\RatingController::class, 'index'])->name('admin.rating');
Route::get('admin/rating/create', [App\Http\Controllers\Admin\RatingController::class, 'create'])->name('admin.rating.create');
Route::post('admin/rating/insert', [App\Http\Controllers\Admin\RatingController::class, 'insert'])->name('admin.rating.insert');
Route::get('admin/rating/edit/{id}', [App\Http\Controllers\Admin\RatingController::class, 'edit'])->name('admin.rating.edit');
Route::post('admin/rating/update/{id}', [App\Http\Controllers\Admin\RatingController::class, 'update'])->name('admin.rating.update');
Route::get('admin/rating/delete/{id}', [App\Http\Controllers\Admin\RatingController::class, 'destroy'])->name('admin.rating.destory');


# Driver Withdrawal Request
Route::get('admin/driver/withdrawal/request', [App\Http\Controllers\Admin\DriverWithdrawalRequestController::class, 'index'])->name('admin.driver.withdrawal.request');
Route::get('admin/driver/withdrawal/edit/{id}', [App\Http\Controllers\Admin\DriverWithdrawalRequestController::class, 'edit'])->name('admin.driver.withdrawal.edit');
Route::post('admin/driver/withdrawal/update/{id}',[App\Http\Controllers\Admin\DriverWithdrawalRequestController::class, 'update'])->name('admin.driver.withdrawal.update');
