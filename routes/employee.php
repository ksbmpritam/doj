...
Route::get('employee/users/profile', [App\Http\Controllers\Employee\HomeController::class, 'profile'])->name('employee.users.profile');
Route::put('employee/users/profile/update/{id}', [App\Http\Controllers\Employee\HomeController::class, 'updateprofile'])->name('employee.users.profile.update');
Route::get('employee/users/password', [App\Http\Controllers\Employee\HomeController::class, 'password'])->name('employee.users.password');
Route::put('employee/users/password/update/{id}', [App\Http\Controllers\Employee\HomeController::class, 'updatepassword'])->name('employee.users.password.update');
