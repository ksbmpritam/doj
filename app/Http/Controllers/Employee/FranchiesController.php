...
class FranchiesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("employee.franchies.index",compact('franchise'));
    }

    public function create()
    {
        $role = Roles::orderBy('id', 'desc')->get();
        return view('employee.franchies.create',compact('role'));
    }
    ...
    public function insert(Request $request)
    {
        ...
        return redirect()->route('employee.franchies')->with('success', 'Franchises inserted successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        $role = Roles::orderBy('id', 'desc')->get();
        return view('employee.franchies.edit', compact('franchise','role'))->with('id', $id);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$franchise) {
            return redirect()->route('employee.franchies')->with('error', 'Franchise not found.');
        }
        ...
        return redirect()->route('employee.franchies')->with('success', 'Franchise updated successfully.');
    }

    public function setting($id){
        $franchise = Franchise::findOrFail($id);
        $role = Roles::orderBy('id', 'desc')->get();
        return view('employee.franchies.setting', compact('franchise','role'))->with('id', $id);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('employee.franchies')->with('success', 'Franchies deleted successfully.');
    }
    
    public function departmentList($id){
        $departments = Department::where('franchies_id',$id)->get();
        return view('employee.franchies.detail.franchies.view', compact('departments'))->with('id', $id);
    }
    
    public function departmentDetail($id){
        $department = Department::findOrFail($id);
        return view('employee.franchies.detail.franchies.department_detail', compact('department'));
    }
    
    public function teamList($id){
        $teams = Team::where('franchies_id',$id)->get();
        return view('employee.franchies.detail.franchies.team_list', compact('teams'))->with('id', $id);
    }
    public function teamDetail($id){
        $team = Team::findOrFail($id);
        return view('employee.franchies.detail.franchies.team_detail', compact('team'));
    }
    public function restaurantList($id){
        ...
        return view('employee.franchies.detail.franchies.restaurant_list', compact('restaurant','restaurants'))->with('id', $id);
    }
    public function restaurantDetail($id){
        $team = Restaurant::findOrFail($id);
        return view('employee.franchies.detail.franchies.restaurant_detail', compact('team'));
    }
    
    // public function zoneList($id){
    //     $zones = Zone::where('franchies_id',$id)->get();
    //     return view('employee.franchies.detail.franchies.zone_list', compact('zones'))->with('id', $id);
    // }
    ...
    public function view($id)
    {
        ...
        $franchise = Franchise::findOrFail($id);
        $role = Roles::orderBy('id', 'desc')->get();
        return view('employee.franchies.view', compact('franchise','role','team_id'))->with('id', $id);
    }
}
