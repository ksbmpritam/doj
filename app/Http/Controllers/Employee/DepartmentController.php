...
{   
    ...
    public function index(Request $request)
    {
        ...
        $department = Department::where('employee_id',$userId)->orderBy('id', 'desc')->get();
    ...
    public function list($id)
    {
        ...
        return view('employee.franchies.detail.franchies.department_list', compact('departments', 'team_id'))->with('id', $id);
    }
    ...
    public function details($id)
    {
        ...
        return view('employee.franchies.detail.franchies.department_detail', compact('department', 'team_id'));
    }
