...
class FoodController extends Controller
{
    ...
    public function productList(Request $request,$id)
    {
        ...
        return view('employee.franchies.detail.franchies.product_list', compact('foods', 'categories','restaurants', 'selectedCategory','restaur_fil','team_ids'));
    }
    ...
    public function productDetail($id)
    {
        ...
        $restaurants = Restaurant::where('team_id',$id)->get();
        return view('employee.franchies.detail.franchies.product_detail', compact('food', 'categories', 'restaurants','team_ids'));
    }
    public function fracnchiesProductEdit($id)
    {
        $team_ids = $id;
        $food = Foods::with(['category', 'restaurant', 'foodAddons', 'foodSpecifications'])->findOrFail($id);
        $categories = Category::all();
        ...
        $restaurants = Restaurant::where('team_id',$id)->get();
        return view('employee.franchies.detail.franchies.product_edit', compact('food', 'categories', 'restaurants','team_ids'));
    }
    
    public function fracnchiesProductUpdate($id, Request $request) {
        ...
        $Foods->approved_by = "emp_" . Session::get('user')->name;
        $Foods->approved_by_id = Session::get('user')->id;
        $Foods->approved_date = Carbon::now()->format('Y/m/d');
        $Foods->cancel_reason = $cancel_reason;
        $Foods->save();
    
        return redirect()->route('employee.franchies.team.product', $Foods->team_id)->with('success', 'Product updated successfully.');
    }
    ...
    public function approvalEdit($id){
        ...
        return view('employee.team.detail.update_product_status', compact('product','team_id'));
    }
    ...
    public function approvalUpdate($id, Request $request){
        ...
        return redirect()->route('employee.team.product', ['id' => $product->team_id])->with('success', 'Product status updated successfully.');
    }
}
