...
class RequestController extends Controller
{
	...
	public function index()
    {
        ...
        return view("employee.request.restaurants.index", compact('restaurant', 'franchiseNames', 'employeeNames'));
    }
    ...
    public function view($id)
    {
        try {
            ...
            return view('employee.request.restaurants.view', compact('restaurant', 'categories', 'restaurant_admin', 'workingHours', 'specialOffers', 'galleryImages','dineImages','days'));
    ...
    {
        $restaurant = Restaurant::findOrFail($id);
        return view('employee.request.restaurants.model', compact('restaurant'));
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('employee.request.restaurants.edit', compact('restaurant','team_ids', 'categories', 'restaurant_admin', 'workingHours', 'specialOffers', 'galleryImages','dineImages','days'));
        } catch (\Illuminate\Database\Eloquent\ModelNotFoundException $exception) {
        }
    }
    ...
    public function Update($id, Request $request) {
        ...
        return redirect()->route('employee.restaurants.request')->with('success', 'Restaurant updated successfully.');
    }
    ...
    public function riderList()
    {
        ...
        return view('employee.request.drivers.index', compact('drivers', 'franchiseNames', 'employeeNames'));
    }
    ...
    public function riderDetail($id)
    {
        ...
        return view('employee.request.drivers.view', compact('driver'))->with('id', $id);
    }


    public function riderEdit($id){
        $driver = Driver::findOrFail($id);
        return view('employee.request.drivers.edit', compact('driver'));
    }
    ...
    public function approvalUpdate($id, Request $request){
        ...
        return redirect()->route('employee.rider.request')->with('success', 'Rider updated successfully.');
    }

    public function showRider($id)
    {
        $driver = Driver::findOrFail($id);
        return view('employee.request.drivers.model', compact('driver'));
    }
    ...
    public function updateRider(Request $request, $id)
    {
        ...
        return redirect()->route('employee.rider.request')->with('success', 'Driver updated successfully.');
    }
    ...
    public function productList()
    {
        ...
        return view('employee.request.product.index', compact('foods', 'categories','franchiseNames','employeeNames'));
    }
    ...
    public function productDetail($id)
    {
        ...
        return view('employee.request.product.view', compact('food', 'categories', 'restaurants'));
    }
    ...
    public function showProduct($id)
    {
        ...
        return view('employee.request.product.model', compact('foods'));
    }
    ...
    public function updateProduct(Request $request, $id)
    {
        ...
        return redirect()->route('employee.product.request')->with('success', 'Food updated successfully.');
    }


    public function productEdit($id){
        $foods = Foods::findOrFail($id);
        return view('employee.request.product.edit', compact('foods'));
    }
    ...
    public function approvalProduct($id, Request $request){
        ...
        return redirect()->route('employee.product.request')->with('success', 'Product updated successfully.');
    }
    ...
    public function showFranchiesDetails($id)
    {
        ...
        return view('employee.request.fsc_model', compact('franchise'));
    }
    
    public function showEmployeeDetails($id)
    {
        $employee = Employee::findOrFail($id);
        return view('employee.request.emp_model', compact('employee'));
    }
    
    public function showTeamDetails($id)
    {
        $team = Team::findOrFail($id);
        return view('employee.request.team_model', compact('team'));
    }
