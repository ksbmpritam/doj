...
class RatingController extends Controller
{
    public function index(Request $request){
        ...
        $ratings = Rating::with('customer','restaurant')->where('restaurant_id', $this->user->id)->orderBy('created_at', 'desc')->get();
        // dd($ratings);
        return view('restaurant_admin.rating.index', compact('ratings'));
    }
