...
class OrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $orders->with(['restaurant', 'users', 'driver'])->where('team_id',$userId)->orderBy('id', 'desc');
        // Get all matching results without pagination
        $orders = $orders->get();
    
        return view('team.orders.index', compact('orders'));
    }
 	...
 	public function edit($id)
    {
        ...
        return view('team.orders.order_edit',compact('orders','id'));
    }
    ...
    public function delete($id){
        ...
        $order->delete();
        return redirect()->route('team.orders')->with('success', 'orders deleted successfully.');
    ...
    public function orderprint($id){
        return view('team.orders.print')->with('id',$id);
    }
