...
class FoodController extends Controller
{
    ...
    public function approvalUpdate($id, Request $request){
        ...
        return redirect()->route('franchies.team.rider', ['id' => $product->team_id])->with('success', 'Product status updated successfully.');
    }
     public function procuctsapproved($id)
    {
        $driver = Foods::findOrFail($id);
        return view('team.products.approved',compact('driver'));
    }
        ...
        public function view($id)
    {
        ...
        $restaurants = Restaurant::where('team_id',$userId)->get();
        return view('team.products.view', compact('food', 'categories', 'restaurants'));
    }
