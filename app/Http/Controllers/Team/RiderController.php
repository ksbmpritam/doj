...
class RiderController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $driver->employee_id = Session::get('user')->employee_id;
        $driver->franchies_id = Session::get('user')->franchies_id;
    ...
    public function riderList($id)
    {
        ...
        return view('franchies.team.detail.rider_list', compact('drivers', 'driver','team_id'));
    }
    ...
    public function riderDetail($id)
    {
        try {
            $team_id = $id;
            $driver = Driver::findOrFail($id);
            return view('franchies.team.detail.rider_detail', compact('driver','team_id'))->with('id', $id);
    ...
    public function approvalUpdate($id, Request $request){
        ...
        return redirect()->route('franchies.team.rider', ['id' => $driver->team_id])->with('success', 'Restaurant status updated successfully.');
    }
    
    public function showRiders($id)
    {
        $driver = Driver::findOrFail($id);
        return view('team.drivers.approved', compact('driver'));
    }
//   public function showEmployeeDetails($employee_id)
// {
//     $employee = Driver::findOrFail($employee_id); 
  
//     return view('team.drivers.emp_model', compact('employee'));
// }
