...
class RiderController extends Controller
{
    ...
    public function approvalUpdate($id, Request $request) {
        ...
        if (!$Driver) {
            return redirect()->back()->with('error', 'Rider not found.')->withInput();
        }
        ...
        return redirect()->route('franchies.team.rider', ['id' => $Driver->team_id])->with('success', 'Rider updated successfully.');
    }
    // public function approvalUpdate($id, Request $request){
    //     $driver = Driver::findOrFail($id);
