...
class RequestController extends Controller
{
    ...
    {
        $franch_id= Session::get('user')->id;
        $restaurant = Restaurant::with(['team'])->where('franchies_id',$franch_id)
            ->orderBy('id', 'desc')
            ->get();
        ...
        return view("franchies.request.restaurants.index", compact('restaurant', 'franchiseNames', 'employeeNames'));
    }
    ...
    public function view($id)
    {
        try {
            ...
            return view('franchies.request.restaurants.view', compact('restaurant', 'categories', 'restaurant_admin', 'workingHours', 'specialOffers', 'galleryImages','dineImages','days'));
    ...
    {
        $restaurant = Restaurant::findOrFail($id);
        return view('franchies.request.restaurants.model', compact('restaurant'));
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('franchies.request.restaurants.edit', compact('restaurant','team_ids', 'categories', 'restaurant_admin', 'workingHours', 'specialOffers', 'galleryImages','dineImages','days'));
        } catch (\Illuminate\Database\Eloquent\ModelNotFoundException $exception) {
        }
    }
    ...
    public function Update($id, Request $request) {
        ...
        $admin->approved_by_name = Session::get('user')->name;
        $admin->approved_by_id = Session::get('user')->id;
        $admin->approved_date = Carbon::now()->format('Y/m/d');
        $admin->cancel_reason = $cancel_reason;
        $admin->save();
    
        return redirect()->route('franchies.restaurants.request')->with('success', 'Restaurant updated successfully.');
    }
    ...
    {
        $franch_id= Session::get('user')->id;
        $drivers = Driver::with(['team'])->where('franchies_id',$franch_id)
            ->orderBy('id', 'desc')
            ->get();
        ...
        return view('franchies.request.drivers.index', compact('drivers', 'franchiseNames', 'employeeNames'));
    }
    ...
    public function riderDetail($id)
    {
        ...
        return view('franchies.request.drivers.view', compact('driver'))->with('id', $id);
    }


    public function riderEdit($id){
        $driver = Driver::findOrFail($id);
        return view('franchies.request.drivers.edit', compact('driver'));
    }
    ...
    public function approvalUpdate($id, Request $request){
        ...
        $Driver->approved_by_name = Session::get('user')->name;
        $Driver->approved_by_id = Session::get('user')->id;
        $Driver->approved_date = Carbon::now()->format('Y/m/d');
        $Driver->cancel_reason = $cancel_reason;
        $Driver->save();
    
        return redirect()->route('franchies.rider.request')->with('success', 'Rider updated successfully.');
    }

    public function showRider($id)
    {
        $driver = Driver::findOrFail($id);
        return view('franchies.request.drivers.model', compact('driver'));
    }
    ...
    public function updateRider(Request $request, $id)
    {
        ...
        return redirect()->route('franchies.rider.request')->with('success', 'Driver updated successfully.');
    }
    ...
    public function productList()
    {
        ...
        $categories = Category::all();
        $franch_id= Session::get('user')->id;
        $foodsQuery = Foods::with(['category', 'restaurant', 'team'])->where('franchies_id',$franch_id)
            ->orderBy('id', 'desc');
        ...
        return view('franchies.request.product.index', compact('foods', 'categories','franchiseNames','employeeNames'));
    }
    ...
    public function productDetail($id)
    {
        ...
        return view('franchies.request.product.view', compact('food', 'categories', 'restaurants'));
    }
    ...
    public function showProduct($id)
    {
        ...
        return view('franchies.request.product.model', compact('foods'));
    }
    ...
    public function updateProduct(Request $request, $id)
    {
        ...
        return redirect()->route('franchies.product.request')->with('success', 'Food updated successfully.');
    }


    public function productEdit($id){
        $foods = Foods::findOrFail($id);
        return view('franchies.request.product.edit', compact('foods'));
    }
    ...
    public function approvalProduct($id, Request $request){
        ...
        $Foods->approved_by_name = Session::get('user')->name;
        $Foods->approved_by_id =Session::get('user')->id;
        $Foods->approved_date = Carbon::now()->format('Y/m/d');
        $Foods->cancel_reason = $cancel_reason;
        $Foods->save();
    
        return redirect()->route('franchies.product.request')->with('success', 'Product updated successfully.');
    }
    ...
    public function showFranchiesDetails($id)
    {
        ...
        return view('franchies.request.fsc_model', compact('franchise'));
    }
    
    public function showEmployeeDetails($id)
    {
        $employee = Employee::findOrFail($id);
        return view('franchies.request.emp_model', compact('employee'));
    }
    
    public function showTeamDetails($id)
    {
        $team = Team::findOrFail($id);
        return view('franchies.request.team_model', compact('team'));
    }
