...
class RestaurantController extends Controller
{
    ...
    public function restaurantDetail($id)
    {
        try {
            ...
            return view('franchies.team.detail.restaurant_detail', compact('restaurant','team_id', 'categories', 'restaurant_admin', 'workingHours', 'specialOffers', 'galleryImages','dineImages','days'));
        } catch (\Illuminate\Database\Eloquent\ModelNotFoundException $exception) {
        }
    }
    public function approvalEdit($id){
        $restaurant = Restaurant::findOrFail($id);
        $team_id = $restaurant->team_id;
        return view('franchies.team.detail.update_status', compact('restaurant','team_id'));
    }
    ...
    public function approvalUpdate($id, Request $request) {
        ...
        return redirect()->route('franchies.team.restaurant', ['id' => $admin->team_id])->with('success', 'Restaurant updated successfully.');
    }
