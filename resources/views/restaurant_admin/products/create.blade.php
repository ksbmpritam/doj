          ...
          <div class="restaurant_payout_create-inner">
            ...
            <fieldset>
              ...
              <div class="form-group row width-50">
                ...
                <div class="col-7">
                  <input type="number" class="form-control food_price" name="price"  oninput="validateInput(this)">
                  <div class="form-text text-muted">
                    @if ($errors->has('price'))
              ...
              <div class="form-group row width-50">
                ...
                <div class="col-7">
                  <input type="number" class="form-control food_discount" name="discount" oninput="validateInput(this)">
                  <div class="form-text text-muted">
              ...
              <div class="form-group row width-50">
                ...
                <div class="col-7">
                  <input type="number" class="form-control item_quantity" min="0" name="item_quantity" oninput="validateInput(this)">
                  <div class="form-text text-muted">
