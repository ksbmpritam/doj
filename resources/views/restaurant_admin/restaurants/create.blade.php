                        ...
                        <div class="restaurant_payout_create-inner">
                            <fieldset>
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class="form-control user_first_name" name="first_name" required>
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="email" class="form-control user_email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2, 4}$" required>
                                        <div class="form-text text-muted">
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="password" class="form-control user_password" name="password" required>
                                        <div class="form-text text-muted">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class="form-control restaurant_name" name="restaurant_name" required>
                                        <div class="form-text text-muted">
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class="form-control restaurant_phone" name="restaurant_phone" required>
                                        <div class="form-text text-muted">
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class="form-control restaurant_address" name="address" required>
                                        <div class="form-text text-muted">
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input class="form-control restaurant_latitude" type="number" name="latitude" min="-90" max="90" >
                                        <div class="form-text text-muted">
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input class="form-control restaurant_longitude" name="longitude" type="number" min="-180" max="180">
                                        <div class="form-text text-muted">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row width-100">
                                        ...
                                        <div class="col-7">
                                            <input type="number" class="form-control" name="charges_per_km" id="delivery_charges_per_km" name="restaurants_per_km">
                                        </div>
                                    </div>
                                    <div class="form-group row width-100">
                                        <label class="col-4 control-label">{{trans('lang.minimum_delivery_charges')}}</label>
                                        <div class="col-7">
                                            <input type="number" class="form-control" name="charges_km_min" id="minimum_delivery_charges" name="restaurants_charges">
                                        </div>
                                    </div>
                                    <div class="form-group row width-100">
                                        <label class="col-4 control-label">{{trans('lang.minimum_delivery_charges_within_km')}}</label>
                                        <div class="col-7">
                                            <input type="number" class="form-control" name="charge_within_km" id="minimum_delivery_charges_within_km" name="restaurants_km">
                                        </div>
                                    </div>
