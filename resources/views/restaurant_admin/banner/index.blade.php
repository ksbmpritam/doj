                        ...
                        <div class="card">
                              ...
                              <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                                  ...
                                  <li class="nav-item">
                                    ...
                                    <a class="nav-link" href="{{ url('banner/create') }}"><i class="fa fa-plus mr-2"></i>{{trans('lang.menu_items_create')}}</a>
                                    ...
                                    <!--    <i class="fa fa-trash"></i> {{trans('lang.all')}}</a></label></th>-->
                                        ...
                                        @foreach ($banners as $banner)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('banner/edit/' . $banner->id) }}" class="btn btn-primary">Edit</a>
