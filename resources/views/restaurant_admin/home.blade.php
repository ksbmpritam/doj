            ...
            <div class="card-body">
                ...
                <div class="row business-analytics_list">
                    ...
                    <div class="col-sm-6 col-lg-3 mb-3">
                        <div class="card-box" onclick="location.href=''">
                            <h5>Order</h5>
                            <!--<strong>5245</strong>-->
                    ...
                    <div class="col-sm-6 col-lg-3 mb-3">
                        <div class="card-box" onclick="location.href='{!! route('restaurant.drivers') !!}'">
                            <h5>Foods</h5>
                            <!--<strong>20</strong>-->
                            <h2 id="order_count">{{$food}}</h2>
                    ...
                    <div class="col-sm-6 col-lg-3 mb-3">
                        <div class="card-box" onclick="location.href='{!! route('restaurant.drivers') !!}'">
                            <h5>Total Earning</h5>
                            <h2 id="order_count">{{$orderAmount}}</h2>
                            <i class="fa fa-money" aria-hidden="true" style="background:#28a745;"></i>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-xl-3 mb-2 mb-sm-0">
                                        <div class="media">
                                            ...
                                            <div class="media-body my-auto">
                                                <h4 class="font-weight-bolder mb-0" id="product_count">{{$food}}</h4>
