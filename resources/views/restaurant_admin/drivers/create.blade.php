                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link " href="{!! route('restaurant.drivers') !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.driver_plural')}} List </a>
                            </li>
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link active" href="{!! route('restaurant.drivers.create') !!}"><i class="fa fa-plus mr-2"></i>Create {{trans('lang.driver_plural')}}</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
