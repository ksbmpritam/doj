...
@section('content')
    <div class="page-wrapper">
        <form action="{{ url ('restaurant/restaurants/update/'.$restaurant->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                                href="{!! route('restaurant.restaurants') !!}">{{trans('lang.restaurant_plural')}}</a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                            ...
                            <div class="restaurant_payout_create-inner">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row width-50">
                                        ...
                                        <div class="col-7">
                                            <input type="text" class="form-control user_first_name" value="{{$restaurant_admin->first_name}}" name="first_name" required>
                                    ...
                                    <div class="form-group row width-50">
                                        ...
                                        <div class="col-7">
                                            <input type="text" class="form-control user_last_name" value="{{$restaurant->last_name}}" name="last_name" required>
                                            <div class="form-text text-muted">
                                    ...
                                    <div class="form-group row width-50">
                                        ...
                                        <div class="col-7">
                                            <input type="email" class="form-control user_email" value="{{$restaurant->email}}" name="email" required>
                                            <div class="form-text text-muted">
                                    ...
                                    <div class="form-group row width-50">
                                        ...
                                        <div class="col-7">
                                            <input type="text" class="form-control" id="mobile_no" value="{{$restaurant->phone}}" onkeypress="return numeralsOnly(event)" maxlength="10" name="phone" >
                                            <!--<input type="text" class="form-control " value="{{$restaurant->phone}}" name="phone" required>-->
                                    ...
                                    <div class="form-group row width-100">
                                        ...
                                        <div class="uploaded_image_owner" >
                                            <img id="uploaded_image_owner" src="{{ asset('images/restaurants/profile/'.$restaurant->profile_image) }}" width="150px" height="150px;" style="border-radius:3px;">
                                        </div>
                                    </div>
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row width-50">
                                        ...
                                        <div class="col-7">
                                            <input type="text" class="form-control restaurant_name" value="{{ $restaurant->name }}" name="restaurant_name" required>
                                            <div class="form-text text-muted">
                                    ...
                                    <div class="form-group row width-50">
                                        <label class="col-3 control-label">{{trans('lang.restaurant_phone')}} <span>*</span></label>
                                        <div class="col-7">
                                            <input type="text" class="form-control" id="restaurant_phone" value="{{$restaurant->phone}}" onkeypress="return res_numeralsOnly(event)" maxlength="10" name="restaurant_phone" >

                                            <!--<input type="text" class="form-control restaurant_phone" name="restaurant_phone" value="{{$restaurant->phone}}" required>-->
                                            <div class="form-text text-muted">
                                    ...
                                    <div class="form-group row width-50">
                                        ...
                                        <div class="col-7">
                                            <input type="text" class="form-control restaurant_address" name="address" value="{{$restaurant->address}}" required>
                                            <div class="form-text text-muted">
                ...
                <div class="form-group col-12 text-center btm-btn">
                    ...
                    <a href="{!! route('restaurant.restaurants') !!}" class="btn btn-default"><i
