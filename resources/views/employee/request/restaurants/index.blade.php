                            ...
                            <table id="data-table" class="display nowrap table table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody id="append_restaurants">
                                    ...
                                    <tr>
                                        ...
                                        data-employee-name="{{ $r->team && $r->employee_id ? App\Models\Employee::find($r->team->employee_id)->name : 'N/A' }}" style="cursor:pointer;">
                                        ...
                                        <td>
                                            <a href="{{ route('employee.restaurants.request.edit', $r->id) }}"
                                                class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Edit" ><i class="fa fa-edit"></i></a>
                                            <a href="{{ route('employee.restaurants.request.view', $r->id) }}"
...
<script>
    $(document).ready(function () {
        ...
        $('.open-modal').on('click', function () {
            ...
            $.ajax({
                url: '/employee/restaurant/request/' + restaurantId,
                type: 'GET',
