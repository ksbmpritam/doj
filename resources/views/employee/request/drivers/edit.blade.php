...
<div class="page-wrapper">
    <form action="{{ url ('employee/rider/request/approvalUpdate/'.$driver->id)}}" method="post" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card">
                    <div class="body-card">
                        ...
                        <div class="form-group col-12 text-center btm-btn">
                            ...
                            <a href="{!! route('employee.rider.request') !!}" class="btn btn-default">
