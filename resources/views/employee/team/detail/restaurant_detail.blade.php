                ...
                <div class="card">
                    <div class="body-card">
                                    ...
                                    <div class="restaurant_payout_create-inner">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                ?>
                                                <div class="form-check width-100">
                                                    <input type="checkbox" id="Good_for_Dinner" disabled name="services[]" value="Good for Dinner" <?php echo $hasGoodForDinner ? 'checked' : ''; ?>>
                        ...
                        <div class="form-group col-12 text-center btm-btn">
                            <a href="{!! route('employee.team.restaurant', ['id' =>$restaurant->team_id]) !!}" class="btn btn-default"><i
