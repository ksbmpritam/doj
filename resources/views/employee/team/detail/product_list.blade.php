            ...
            <div class="col-12">
                ...
                <div class="card">
                   <div class="card-body">
                        ...
                        <form action="{{ route ('employee.team.product', $team_id)}}" method="get" enctype="multipart/form-data">
                            <div id="users-table_filter" class="pull-right"><label>Filter By :
                                    ...
                                    <div class="form-group">
                                        <select id="category_search_dropdown" name="category" class="form-control">
                                            ...
                                            <option value="{{$ct->id}}" selected>{{isset($ct->name)?$ct->name:""}}
                                            </option>
                                            @else
                                    ...
                                    <button type="submit" class="btn btn-warning btn-flat"><i class="fa fa-search">
                                        </i></button>
                                    <a href="{{ route ('employee.team.product', $team_id)}}" class="btn btn-warning btn-flat"><i
                        ...
                        <div class="table-responsive m-t-10">
                            ...
                            <table id="data-table"
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ asset('images/foods/' . $f->images) }}" width="100" height="100"
                                            alt="categories Photo"></td>
                                    <td>{{$f->name}}</td>
                                    ...
                                    <td>
                                        <a href="{{ route('employee.team.approvalProduct.edit' , $f->id) }}" class="btn btn-primary"> <i
                                                class="fa fa-edit"></i> </a>
                                        <a href="{{ route('employee.team.view.productDetail' , $f->id) }}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                                @endforeach
