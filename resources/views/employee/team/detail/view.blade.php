                                    ...
                                    <tbody id="append_restaurants">
                                        ...
                                        @foreach($restaurant as $r)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('employee.team.view.restaurantDetail' , $r->id) }}" class="btn btn-secondary"><i class="fa fa-eye"></i></a>
                                                    <a href="{{ route('employee.team.approval.edit' , $r->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
