                            ...
                            <div class="resttab-sec">
                                ...
                                <div class="row restaurant_payout_create">
                                    <div class="restaurant_payout_create-inner">
                                        <form action="{!! route('employee.team.approvalProduct.update', ['id' => $product->id]) !!}" method="POST">
                                            @csrf
                                            ...
                                            <div class="form-group col-12 text-center btm-btn">
                                                ...
                                                <a href="{!! route('employee.team.product', ['id' => $product->team_id]) !!}" class="btn btn-default"><i class="fa fa-undo"></i> Cancel</a> <!-- Updated the text for "Cancel" button -->
                                            </div>
                                        </form>
