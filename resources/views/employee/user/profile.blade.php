 ...
 <div class="profile-form">
    <div class="card-body">
        ...
        <div class="column">
            ...
            @endif
            <form method="post" action="{{ route('employee.users.profile.update',['id'=>$user->id]) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row restaurant_payout_create">
                    <div class="twPc-div">
                        <div class="container">
                            <a>
                                <img id="profileImagePreview" alt="profile" src="{{ asset('images/employee/profile/' .$user->image) }}" class="twPc-avatarImg">
