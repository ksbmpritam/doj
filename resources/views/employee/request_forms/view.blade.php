...
<div class="page-wrapper">
    <form action="{{ url ('employee/form/update/'. $forms->id)}}" method="Post" enctype="multipart/form-data">
        @csrf
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{!! route('employee.form') !!}">Request List</a>
                    </li>
            ...
            <div class="cat-edite-page max-width-box">
                <div class="card  pb-4">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link " href="{!! route('employee.form') !!}"><i class="fa fa-list mr-2"></i>Request List</a>
                            </li>
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="category_information">
                                    <fieldset>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" name="title" value="{{ $forms->title }}" readonly>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" name="description" value="{{ $forms->description }}" readonly>
                                                <div class="form-text text-muted">
                                                    @error('description')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                    ...
                    <div class="form-group col-12 text-center btm-btn">
                        ...
                        <!--    {{trans('lang.save')}}-->
                        <!--</button>-->
                        <a href="{!! route('employee.form') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
                    </div>
