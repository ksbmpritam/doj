...
<div class="page-wrapper">
    <form action="{{ url ('franchise/team/update/'. $team->id)}}" method="Post" enctype="multipart/form-data">
        @csrf
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{!! route('franchise.department') !!}">Team List</a>
                    </li>
