        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <!--        </li>-->
                    <!--        <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">-->
                    <!--            <a class="nav-link" href="{!! route('employee.franchies.create') !!}"><i class="fa fa-plus mr-2"></i>Create Franchies</a>-->
                    <!--        </li>-->
                    <!--    </ul>-->
                    <!--</div>-->
                                ...
                                <tbody >
                                  @foreach($franchise as $fran)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('employee/franchies/edit/' . $fran->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                            <a href="{{ url('employee/franchies/view/' . $fran->id) }}" class="btn btn-sm btn-secondary"><i class="fa fa-eye"></i></a>
                                            <a href="{{ url('employee/franchies/setting/' . $fran->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-cogs" aria-hidden="true"></i></a>
                                            <!--<a href="{{ url('employee/franchies/delete/' . $fran->id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this Franchies ?')"><i class="fa fa-trash"></i></a>-->
                                        </td>
                                    </tr>
                                    @endforeach
