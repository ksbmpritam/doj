...
<div class="page-wrapper">
    <form action="{{ url ('employee/franchies/insert')}}" method="Post" enctype="multipart/form-data">
        @csrf
                                ...
                                <div class="restaurant_payout_create-inner">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" id="mobile_no" onkeypress="return numeralsOnly(event)" maxlength="12" name="mobile_no" value="{{ old('mobile_no') }}">
                                                <div class="form-text text-muted">
                                                    @error('mobile_no')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
