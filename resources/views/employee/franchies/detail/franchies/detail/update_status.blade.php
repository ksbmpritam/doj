                            ...
                            <div class="resttab-sec">
                                ...
                                <div class="row restaurant_payout_create">
                                    <div class="restaurant_payout_create-inner">
                                        <form action="{!! route('franchies.team.approval.update', ['id' => $restaurant->id]) !!}" method="POST">
                                            @csrf
                                            @method('PUT') <!-- Assuming you are using PUT to update the record -->
                                        
                                            <fieldset>
                                                <legend>Restaurant Approval</legend>
                                                <div class="form-group row">
                                                    ...
                                                    <select name="team_approvel" id="team_approvel" class="form-control"> <!-- Added 'form-control' class for styling -->
                                                        <option value="1" @if($restaurant->team_approvel == 1) selected @endif>Approved</option>
                                                        <option value="0" @if($restaurant->team_approvel == 0) selected @endif>Progress</option>
                                                        <option value="-1" @if($restaurant->team_approvel == -1) selected @endif>Unapproved</option>
                                                    </select>
                                                </div>
                                            </fieldset>
                                            <div class="form-group col-12 text-center btm-btn">
                                                ...
                                                <a href="{!! route('franchies.team.restaurant', ['id' => $restaurant->team_id]) !!}" class="btn btn-default"><i class="fa fa-undo"></i> Cancel</a> <!-- Updated the text for "Cancel" button -->
                                            </div>
                                        </form>
