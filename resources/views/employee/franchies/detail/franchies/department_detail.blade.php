...
<div class="page-wrapper">
    <form action="{{ url ('employee/franchies/department/update/'. $department->id)}}" method="Post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="cat-edite-page max-width-box">
                ...
                <div class="card  pb-4">
                    ...
                    <div class="form-group col-12 text-center btm-btn">
                        ...
                        <!--    {{trans('lang.save')}}-->
                        <!--</button>-->
                        <a href="{{ route('employee.franchies.department.list', ['id' => $department->franchies_id]) }}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
                    </div>
