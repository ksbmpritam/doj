...
<div class="page-wrapper">
    <form action="{{ url ('employee/franchies/team/restaurant/update/'.$restaurant->id)}}" method="post" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card">
                    <div class="body-card">
                        ...
                        <div class="form-group col-12 text-center btm-btn">
                            ...
                            <a href="{!! route('employee.franchies.team.restaurant', ['id' =>$restaurant->team_id]) !!}" class="btn btn-default">
