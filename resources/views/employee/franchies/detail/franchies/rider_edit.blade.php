...
<div class="page-wrapper">
     <form action="{{ url ('employee/franchies/team/rider/update/'.$driver->id)}}" method="post" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card">
                    <div class="body-card">
                        ...
                        <div class="form-group col-12 text-center btm-btn">
                            ...
                            <a href="{!! route('employee.franchies.team.rider', ['id' =>$driver->team_id]) !!}" class="btn btn-default">
