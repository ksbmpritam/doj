...
<div class="page-wrapper">
    <form action="{{ url ('team/riders/update/'.$driver->id)}}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="container-fluid">
                        ...
                        <div class="card-header">
                            <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                                <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                    <a class="nav-link " href="{!! route('employee.franchies.team.rider',['id' => $driver->team_id]) !!}"><i class="fa fa-list mr-2"></i>Rider List </a>
                                </li>
                                <li class="nav-item" style="border: 1px solid #ff683a; border-radius: 2px;">
                                ...
                                <div class="restaurant_payout_create-inner">
                                    <fieldset>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control  @error('first_name') is-invalid @enderror" name="first_name" value="{{$driver->first_name}}" readonly>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" value="{{$driver->last_name}}" readonly>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control @error('father_name') is-invalid @enderror" name="father_name" value="{{$driver->father_name}}" readonly>
                                                <div class="form-text text-muted">
                                                    @error('father_name')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $driver->email }}" readonly>
                                                <div class="form-text text-muted">
                                                    @error('email')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{$driver->address}}" readonly>
                                                <div class="form-text text-muted">
                                                    @error('address')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control @error('state') is-invalid @enderror" name="state" value="{{$driver->state}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control @error('city') is-invalid @enderror" name="city" value="{{$driver->city}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control @error('language') is-invalid @enderror" name="language" value="{{ $driver->language}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="number" class="form-control" name="latitude" step="any" value="{{$driver->latitude}}" readonly>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="number" class="form-control" name="longitude" step="any" value="{{$driver->longitude}}" readonly>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="file" class="" name="profile_image" readonly>
                                        ...
                                        <div class="form-group row width-50">
                                            <label class="col-3 control-label">Work Area</label>
                                            <div class="col-7">
                                                <input type="text" class="form-control" name="work_area" value="{{$driver->work_area}}" readonly>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" name="vehicle" value="{{$driver->vehicle}}" readonly>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group row">
                                            <div class="form-group row width-50">
                                                ...
                                                <div class="col-7">
                                                    <input type="number" class="form-control @error('aadhar_no') is-invalid @enderror" name="aadhar_no" value="{{$driver->aadhar_no}}" readonly>
                                            ...
                                            <div class="form-group row width-50">
                                                ...
                                                <div class="col-7">
                                                    <input type="text" class="form-control @error('pan_card_no') is-invalid @enderror" name="pan_card_no" value="{{$driver->pan_card_no}}" readonly>
                                                    <small class="form-text text-muted">
                                                        @error('pan_card_no')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-12">
                                                <input type="text" id="bank_name" name="bank_name" class="form-control" value="{{ old('bank_name', $driver->bank_name) }}" readonly required>
                                                <small class="form-text text-muted">
                                                    @error('bank_name')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                            ...
                                            <div class="col-12">
                                                <input type="text" id="branch_name" name="branch_name" class="form-control" value="{{ old('branch_name', $driver->branch_name) }}" readonly required>
                                                <small class="form-text text-muted">
                                                    @error('branch_name')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-12">
                                                <input type="text" id="account_number" name="account_number" class="form-control" readonly value="{{ old('account_number', $driver->account_number) }}" required>
                                                <small class="form-text text-muted">
                                            ...
                                            <div class="col-12">
                                                <input type="text" id="holder_name" name="holder_name" class="form-control" readonly value="{{ old('holder_name', $driver->holder_name) }}" required>
                                                <small class="form-text text-muted">
                                                    @error('holder_name')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-12">
                                                <input type="text" id="ifsc_code" name="ifsc_code" class="form-control" readonly value="{{ old('ifsc_code', $driver->ifsc_code) }}" required>
                                                <small class="form-text text-muted">
                                                    @error('ifsc_code')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-12">
                                                <textarea id="other_information" name="other_information" readonly class="form-control" rows="4">{{ old('other_information', $driver->other_information) }}</textarea>
                                                <small class="form-text text-muted">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control car_number" name="car_number" value="{{$driver->car_number}}" readonly>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control car_name" name="car_name" value="{{$driver->car_name}}" readonly>
            ...
            <div class="form-group col-12 text-center btm-btn">
                ...
                <a href="{!! route('employee.franchies.team.rider', ['id' => $driver->team_id]) !!}" class="btn btn-default"><i class="fa fa-undo"></i> Cancel</a> <!-- Updated the text for "Cancel" button -->
            </div>
