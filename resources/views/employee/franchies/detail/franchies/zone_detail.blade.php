                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group col-12 text-center btm-btn">
                                ...
                                <a href="{{ url('employee/franchies/zone/list/' . $team_id) }}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
...
<script>
    ...
    function savePolygon(coords) {
        ...
        var updateRoute = "{{ route('employee.zone.update') }}";
        var mainUrl = "{{ route('employee.zone') }}";
