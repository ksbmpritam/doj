                ...
                <div class="card">
                    <div class="body-card">
                                    ...
                                    <div class="restaurant_payout_create-inner">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row width-50">
                                                ...
                                                <div class="col-7">
                                                    <input type="text" class="form-control user_first_name" value="{{$restaurant_admin->first_name}}" name="first_name"  readonly required>
                                            ...
                                            <div class="form-group row width-50">
                                                ...
                                                <div class="col-7">
                                                    <input type="text" class="form-control user_last_name" value="{{$restaurant->last_name}}" name="last_name" readonly required>
                                                    <div class="form-text text-muted">
                                            ...
                                            <div class="form-group row width-50">
                                                ...
                                                <div class="col-7">
                                                    <input type="email" class="form-control user_email" value="{{$restaurant->email}}" name="email" readonly required>
                                                    <div class="form-text text-muted">
                                            ...
                                            <div class="form-group row width-50">
                                                ...
                                                <div class="col-7">
                                                    <input type="text" class="form-control user_password" value="{{$restaurant->password}}" name="password" required>
                                                    <div class="form-text text-muted">
                                            ...
                                            <div class="form-group row width-50">
                                                ...
                                                <div class="col-7">
                                                    <input type="text" class="form-control user_phone" value="{{$restaurant->phone}}" name="phone" readonly required>
                                            ...
                                            <div class="form-group row width-100">
                                                    ...
                                                    <div class="col-7">
                                                        <input type="text" class="form-control" id="permanent_address" name="permanent_address" value="{{ $restaurant->permanent_address }}" readonly>
                                                        <div class="form-text text-muted">
                                                ...
                                                <div class="form-check row width-100">
                                                    <input type="checkbox" class="item_publish" name="address_same" id="address_same" value="1"
                                                        @if($restaurant->address_same == 1) checked @endif disabled>
                                                ...
                                                <div class="form-group row width-100">
                                                    ...
                                                    <div class="col-7">
                                                        <input type="text" class="form-control" id="communication_address" name="communication_address" @if($restaurant->communication_address == 1) readonly @endif value="{{ $restaurant->communication_address }}" readonly>
                                                        <div class="form-text text-muted">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row width-50">
                                                ...
                                                <div class="col-7">
                                                    <input type="text" class="form-control restaurant_name" value="{{ $restaurant->name }}" name="restaurant_name" readonly required>
                                                    <div class="form-text text-muted">
                                            ...
                                            <div class="form-group row width-50">
                                                ...
                                                <div class="col-7">
                                                    <input type="text" class="form-control restaurant_phone" name="restaurant_phone" value="{{$restaurant->phone}}" readonly required>
                                                    <div class="form-text text-muted">
                                            ...
                                            <div class="form-group row width-50">
                                                ...
                                                <div class="col-7">
                                                    <input type="text" class="form-control restaurant_address" name="address" value="{{$restaurant->address}}" readonly required>
                                                    <div class="form-text text-muted">
                                            ...
                                            <div class="form-group row width-50">
                                                ...
                                                <div class="col-7">
                                                    <input type="text" class="form-control restaurant_latitude" name="latitude" value="{{$restaurant->latitude}}" readonly step="0.0000000001">
                                                    <div class="form-text text-muted">
                                            ...
                                            <div class="form-group row width-50">
                                                ...
                                                <div class="col-7">
                                                    <input type="text" class="form-control restaurant_longitude" name="longitude" value="{{$restaurant->longitude}}" readonly step="0.0000000001">
                                                    <div class="form-text text-muted">
                                            ...
                                            <div class="form-group row width-100">
                                                ...
                                                <div class="col-7">
                                                    <textarea rows="7" class="restaurant_description form-control"
                                                              id="restaurant_description" name="description" readonly>{{$restaurant->description}}</textarea>
                                                </div>
                                            </div>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="form-check width-100">
                                                    <input type="checkbox" id="Free_Wi_Fi" name="services[]" disabled value="Free Wi Fi" <?php echo $hasFreeWiFi ? 'checked' : ''; ?>>
                                                ...
                                                ?>
                                                <div class="form-check width-100">
                                                    <input type="checkbox" id="Good_for_Breakfast" name="services[]" disabled value="Good for Breakfast" <?php echo $hasGoodForBreak ? 'checked' : ''; ?>>
                                                ...
                                                ?>
                                                <div class="form-check width-100">
                                                    <input type="checkbox" id="Good_for_Dinner" name="services[]" disabled value="Good for Dinner" <?php echo $hasGoodForDinner ? 'checked' : ''; ?>>
                                                ...
                                                ?>
                                                <div class="form-check width-100">
                                                    <input type="checkbox" id="Good_for_Lunch" name="services[]" disabled value="Good for Lunch" <?php echo $hasGoodForLunch ? 'checked' : ''; ?>>
                                                ...
                                                ?>
                                                <div class="form-check width-100">
                                                    <input type="checkbox" id="Live_Music" name="services[]" disabled value="Live Music" <?php echo $hasLiveMusic ? 'checked' : ''; ?>>
                                                ...
                                                ?>
                                                <div class="form-check width-100">
                                                    <input type="checkbox" id="Outdoor_Seating" name="services[]" disabled value="Outdoor Seating" <?php echo $hasOutDoor ? 'checked' : ''; ?>>
                                                ...
                                                ?>
                                                <div class="form-check width-100">
                                                    <input type="checkbox" id="Takes_Reservations" name="services[]" disabled value="Takes Reservations" <?php echo $hasTakesReservations ? 'checked' : ''; ?>>
                                                ...
                                                ?>
                                                <div class="form-check width-100">
                                                    <input type="checkbox" id="Vegetarian_Friendly" name="services[]" disabled vlaue="Vegetarian Friendly" <?php echo $hasVegetrain ? 'checked' : ''; ?>>
                                       ...
                                       <fieldset>
                                        ...
                                        <div class="working-hours-container">
                                            ...
                                            @foreach($days as $day)
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12">
                                                        <button type="button" class="btn btn-primary add-working-hours" disabled data-days="{{ $day }}">
                                                            Add
                                                        </button>
                                                    </div>
                                                </div>
                                                    ...
                                                    @foreach($workingHours[$day] as $timeSlot)
                                                        <div class="mb-2 row">
                                                            <div class="col-5">
                                                                ...
                                                                <input type="time" class="form-control" disabled name="{{ strtolower($day) }}_start[]" value="{{ $timeSlot['start_time'] }}">
                                                            </div>
                                                            <div class="col-5">
                                                                <label>End Time</label>
                                                                <input type="time" class="form-control" disabled name="{{ strtolower($day) }}_end[]" value="{{ $timeSlot['end_time'] }}">
                                                            </div>
                                                            <div class="col-2">
                                                                <label style="display:block;width:100%;color:#fff">.</label>
                                                                <button type="button" disabled class="btn btn-danger remove-working-hours">X</button>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                </div>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group row width-50">
                                                    <div class="form-check width-100"> 
                                                        <input type="checkbox" id="is_active" value="1"  disabled name="restaurant_status" @if($restaurant->restaurant_status == 1) checked @endif>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group row width-100">
                                                    <div class="form-check width-100">
                                                        <input type="checkbox" name="enable_dine" disabled value="1" id="dine_in_feature" {{ $restaurant->enable_dine == 1 ? 'checked' : '' }}>
                                                ...
                                                <div class="divein_div" style="display: {{ $restaurant->enable_dine == 1 ? 'block' : 'none' }}">
                                                    ...
                                                    <div class="form-group row width-50">
                                                        ...
                                                        <div class="col-7">
                                                            <input type="time" name="dine_open_time" class="form-control" readonly id="openDineTime" value="{{$restaurant->dine_open_time}}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row width-50">
                                                        ...
                                                        <div class="col-7">
                                                            <input type="time" name="dine_close_time" class="form-control" readonly id="closeDineTime" value="{{$restaurant->dine_close_time}}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row width-50">
                                                        ...
                                                        <div class="col-7">
                                                            <input type="number" name="dine_cost_price" class="form-control restaurant_cost" readonly value="{{$restaurant->dine_cost_price}}">
                                                        </div>
                                                    </div>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group row width-100">
                                                    ...
                                                    <div class="col-7">
                                                        <input type="number" class="form-control" readonly id="delivery_charges_per_km" value="{{$restaurant->charges_per_km}}" name="charges_per_km" >
                                                    </div>
                                                </div>
                                                <div class="form-group row width-100">
                                                    <label class="col-4 control-label">{{ trans('lang.minimum_delivery_charges')}}</label>
                                                    <div class="col-7">
                                                        <input type="number" class="form-control" readonly id="minimum_delivery_charges" value="{{$restaurant->charges_km_min}}" name="charges_km_min" >
                                                    </div>
                                                </div>
                                                <div class="form-group row width-100">
                                                    <label class="col-4 control-label">{{ trans('lang.minimum_delivery_charges_within_km')}}</label>
                                                    <div class="col-7">
                                                        <input type="number" class="form-control" readonly id="minimum_delivery_charges_within_km" value="{{$restaurant->charges_km_min}}" name="charge_within_km" >
                                                    </div>
                                                </div>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group row width-100">
                                                    ...
                                                    <div class="col-7">
                                                        <input type="text" name="bank_name" readonly class="form-control" id="bankName" value="{{$restaurant->bank_name}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row width-100">
                                                    ...
                                                    <div class="col-7">
                                                        <input type="text" name="branch_name" readonly class="form-control"
                                                ...
                                                <div class="form-group row width-100">
                                                    ...
                                                    <div class="col-7">
                                                        <input type="text" name="holder_name" readonly class="form-control"
                                                ...
                                                <div class="form-group row width-100">
                                                    ...
                                                    <div class="col-7">
                                                        <input type="text" name="account_number" readonly class="form-control"
                                                ...
                                                <div class="form-group row width-100">
                                                    ...
                                                    <div class="col-7">
                                                        <input type="text" name="ifsc_code" readonly class="form-control"
                                                ...
                                                <div class="form-group row width-100">
                                                    ...
                                                    <div class="col-7">
                                                        <input type="text" name="other_information" readonly class="form-control"
                                                ...
                                                <div class="special-offer-container">
                                                    ...
                                                    @foreach($days as $day)
                                                        <div class="form-group row">
                                                            <label class="col-1 control-label">{{ $day }}</label>
                                                            <div class="col-12">
                                                                <button type="button" disabled class="btn btn-primary add-special-offer" data-day="{{ $day }}">
                                                                    Add
                                                                </button>
                                                            </div>
                                                        </div>
                                                            ...
                                                            @foreach($specialOffers[$day] as $offer)
                                                                <div class="mb-2 row">
                                                                    <div class="col-3">
                                                                        ...
                                                                        <input type="time" class="form-control" readonly name="{{ strtolower($day) }}_start_offer[]" value="{{ $offer['opening_time'] }}">
                                                                    </div>
                                                                    <div class="col-3">
                                                                        <label>Closing Time</label>
                                                                        <input type="time" class="form-control" readonly name="{{ strtolower($day) }}_end_offer[]" value="{{ $offer['closing_time'] }}">
                                                                    </div>
                                                                    <div class="col-4">
                                                                        <div class="row">
                                                                            <div class="col-6">
                                                                                <label>Discount</label>
                                                                                <input type="text" class="form-control" readonly name="{{ strtolower($day) }}_discount[]" value="{{ $offer['discount'] }}">
                                                                            </div>
                                                                            <div class="col-6">
                                                                                <label>%/₹</label>
                                                                                <select id="discount_type{{ ucfirst(strtolower($day)) }}" name="{{ strtolower($day) }}_discount_type[]" class="form-control" disabled>
                                                                    ...
                                                                    <div class="col-2">
                                                                        <label>Type</label>
                                                                        <select id="type{{ ucfirst(strtolower($day)) }}" name="{{ strtolower($day) }}_delivery_type[]" class="form-control" disabled>
                                        ...
                                        <fieldset id="story_upload_div" style="display: none;">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-12">
                                                    <input type="file" id="file" onChange="handleStoryThumbnailFileSelect(event)" readonly>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-12">
                                                    <input type="file" id="video_file" onChange="handleStoryFileSelect(event)" readonly>
                        ...
                        <div class="form-group col-12 text-center btm-btn">
                            <a href="{!! route('employee.franchies.team.restaurant', ['id' =>$restaurant->team_id]) !!}" class="btn btn-default"><i
