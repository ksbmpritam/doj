...
<div class="page-wrapper">
    <form action="{{ url ('franchies/team/update_setting/'. $team->id)}}" method="Post" enctype="multipart/form-data">
        @csrf
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{!! route('franchies.team') !!}">Setting</a></li>
