...
<div class="page-wrapper">
    <form action="{{ url ('franchies/team/insert')}}" method="Post" enctype="multipart/form-data">
        @csrf
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{!! route('franchies.team') !!}">Team</a></li>
                            ...
                            <div class="row restaurant_payout_create">
                                ...
                                <div class="restaurant_payout_create-inner">
                                    <fieldset>
                                        ...
                                        <div class="form-group row width-50">
                                            <label class="col-3 control-label">Profile Image<sup style="color:red;">*</sup></label>
                                            <div class="col-7">
                                        ...
                                        <div class="form-group row width-50">
                                            <label class="col-3 control-label">Department<sup style="color:red;">*</sup></label>
                                            <div class="col-7">
