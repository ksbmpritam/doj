...
<div class="page-wrapper">
    <form action="{{ url ('franchies/team/update/'. $team->id)}}" method="Post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="cat-edite-page max-width-box">
                <div class="card  pb-4">
                            ...
                            <div class="restaurant_payout_create-inner tab-content">
                                <div role="tabpanel" class="tab-pane active" id="category_information">
                                    <fieldset>
                                        ...
                                        <div class="form-group row width-50">
                                            <label class="col-3 control-label">Department</label>
                                            <div class="col-7">
                                                <select class="form-control" id="franchies_department_id" name="franchies_department_id" readonly>
                                                    <option value="" readonly>Select Department</option>
                                                    @foreach($departments as $department)
                                                        <option value="{{ $department->id }}" {{ old('franchies_department_id', $team->franchies_department_id) == $department->id ? 'selected' : '' }}>
                                                            {{ $department->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                <div class="form-text text-muted">
                                                    @error('franchies_department_id')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            </div>
                    ...
                    <div class="form-group col-12 text-center btm-btn">
                        ...
                        <!--    {{trans('lang.save')}}-->
                        <!--</button>-->
                        <a href="{!! route('franchies.team') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
                    </div>
