                        ...
                        <div class="table-responsive m-t-10">
                            ...
                            <table id="data-table" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('franchies/team/rider/approvalRider/edit/' . $d->id) }}" class="btn btn-primary btn-sm"> <i class="fa fa-edit"></i> </a>
                                        <a href="{{ url('franchies/team/rider/riderDetail/' . $d->id) }}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
