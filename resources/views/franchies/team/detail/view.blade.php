                                    ...
                                    <tbody id="append_restaurants">
                                        ...
                                        @foreach($restaurant as $r)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('franchies.team.view.restaurantDetail' , $r->id) }}" class="btn btn-secondary"><i class="fa fa-eye"></i></a>
                                                    <a href="{{ route('franchies.team.approval.edit' , $r->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                                    <!--<a href="{{ url('team/restaurants/delete/' . $r->id) }}" class="btn btn-danger">Delete</a>-->
                                                </td>
                                            </tr>
