                ...
                <div class="card">
                    <div class="body-card">
                                                    ...
                                                    @foreach($workingHours[$day] as $timeSlot)
                                                        <div class="mb-2 row">
                                                            <div class="col-5">
                                                                ...
                                                                <input type="time" class="form-control" readonly name="{{ strtolower($day) }}_start[]" value="{{ $timeSlot['start_time'] }}">
                                                            </div>
                                                            <div class="col-5">
                                                                <label>End Time</label>
                                                                <input type="time" class="form-control" readonly name="{{ strtolower($day) }}_end[]" value="{{ $timeSlot['end_time'] }}">
                                                            </div>
                                                            <div class="col-2">
                                                ...
                                                <div class="special-offer-container">
                                                    ...
                                                    @foreach($days as $day)
                                                        <div class="form-group row">
                                                            <label class="col-1 control-label">{{ $day }}</label>
                                                            <div class="col-12">
                                                                <button type="button" class="btn btn-primary add-special-offer" disabled data-day="{{ $day }}">
                                                                    Add
                                                                </button>
                                                            </div>
                                                        </div>
                        ...
                        <div class="form-group col-12 text-center btm-btn">
                            <a href="{!! route('franchies.team.restaurant', ['id' =>$restaurant->team_id]) !!}" class="btn btn-default"><i
