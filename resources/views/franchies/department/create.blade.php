...
<div class="page-wrapper">
    <form action="{{ url ('franchies/department/insert')}}" method="Post" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card  pb-4">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                            ...
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link active" href="{!! route('franchies.department.create') !!}"><i class="fa fa-plus mr-2"></i>Create Department</a>
                            </li>
                        </ul>
                    </div>
