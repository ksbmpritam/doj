                        ...
                        <div class="table-responsive m-t-10">
                            ...
                            <table id="data-table" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('franchies/form/view/' . $d->id) }}" class="btn btn-sm btn-secondary"><i class="fa fa-eye"></i></a>
                                        <a href="{{ url('franchies/form/edit/' . $d->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                        <a href="{{ url('franchies/form/delete/' . $d->id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this Team ?')"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
