 ...
 <div class="profile-form">
    <div class="card-body">
        ...
        <div class="column">
            ...
            @endif
            <form method="post" action="{{ route('franchies.users.profile.update',['id'=>$user->id]) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row restaurant_payout_create">
                    <div class="twPc-div">
                        <div class="container">
                            <a>
                                <img id="profileImagePreview" alt="profile" src="{{ asset('images/franchies/profile/' .$user->image) }}" class="twPc-avatarImg">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    <input type="text" class="form-control" name="permanent_address"
                                        value="{{ $user->permanent_address }}" placeholder="Address">
