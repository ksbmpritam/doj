...
<div class="page-wrapper">
    <form action="{{ url ('franchies/drivers/request/update/'.$driver->id)}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">Rider Details</h3>
            </div>
        ...
        <div class="container-fluid">
                        ...
                        <div class="card-header">
                            <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                                <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                    <a class="nav-link " href="{!! route('franchies.rider.request') !!}"><i class="fa fa-list mr-2"></i>Rider List </a>
                                </li>
                                <li class="nav-item" style="border: 1px solid #ff683a; border-radius: 2px;">
                                ...
                                <div class="restaurant_payout_create-inner">
                                    <fieldset>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{$driver->phone}}" onkeypress="return numeralsOnly(event)" maxlength="10" >
                                                <div class="form-text text-muted">
                                                    @error('phone')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group row width-100">
                                            ...
                                            <div class="col-12">
                                                <textarea id="other_information" name="other_information"  class="form-control" rows="2">{{ old('other_information', $driver->other_information) }}</textarea>
                                                <small class="form-text text-muted">
            ...
            <div class="form-group col-12 text-center btm-btn">
                ...
                <a href="{!! route('franchies.rider.request') !!}" class="btn btn-default"><i class="fa fa-undo"></i> Cancel</a>
            </div>
