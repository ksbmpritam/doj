...
<div class="page-wrapper">
    <form action="{{ url ('franchies/rider/request/approvalUpdate/'.$driver->id)}}" method="post" enctype="multipart/form-data">
        @csrf
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor orderTitle">Rider/Driver </h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{url('franchies/dashboard')}}">{{trans('lang.dashboard')}}</a></li>
                <li class="breadcrumb-item active">Rider/Driver</li>
            </ol>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="body-card">
                            ...
                            <div class="resttab-sec">
                                ...
                                <div class="row restaurant_payout_create">
                                    <div class="restaurant_payout_create-inner">
                                        ...
                                        <fieldset>
                                            <legend>Driver/Rider Status</legend>
                        ...
                        <div class="form-group col-12 text-center btm-btn">
                            ...
                            <a href="{!! route('franchies.rider.request') !!}" class="btn btn-default">
