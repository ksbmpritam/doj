...
<div class="page-wrapper">
        <form action="{{ url ('franchies/product/request/update/'.$food->id)}}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="cat-edite-page max-width-box">
                <div class="card  pb-4">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link " href="{!! route('franchies.product.request') !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.product')}} List </a>
                            </li>
                            <li class="nav-item" style="border: 1px solid #ff683a; border-radius: 2px;">
                    ...
                    <div class="form-group col-12 text-center btm-btn">
                        ...
                        <a href="{!! route('franchies.product.request') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
        ...
        $('.add-addons-btn').click(function () {
            ...
            let workingHoursRow = `
                <div class="mb-2 row">
                    ...
                    <div class="col-5">
                        <input type="number" class="form-control" name="addons_price[]" placeholder="Price">
                    </div>
                    <div class="col-2">
                        <button type="button" class="btn btn-danger remove-addons">X</button>
                    </div>
        ...
        $('.specification-btn').click(function () {
            ...
            let specificationRow = `
                <div class="mb-2 row">
                    ...
                    <div class="col-5">
                        <input type="number" class="form-control" name="specifications_value[]" placeholder="Value">
                    </div>
                    <div class="col-2">
                        <button type="button" class="btn btn-danger remove-specification">X</button>
                    </div>
