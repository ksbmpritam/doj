<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLongTitle">Restaurant <span id="vendor_title_lable"></span></h5>
    ...
    <div class="form-row">
        <div class="form-group row width-100">
         ...
         <div class="form-group row width-100" id="reasonField" >
            ...
            <div class="col-12">
                <input type="text" class="form-control" value="{{ $restaurant->approved_by_name }}">
