...
@section('content')
    <div class="page-wrapper">
        <form action="{{ url ('franchies/restaurants/update/'.$restaurant->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                                href="{!! route('franchies.restaurants.request') !!}">{{trans('lang.restaurant_plural')}}</a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="form-group col-12 text-center btm-btn">
                    ...
                    <a href="{!! route('franchies.restaurants.request') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
                </div>
