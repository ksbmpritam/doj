            ...
            <div class="card-body">
                ...
                <div class="row business-analytics_list">
                    ...
                    <div class="col-sm-6 col-lg-3 mb-3">
                        <div class="card-box" onclick="location.href='{!! route('franchies.department') !!}'">
                            <h5>Department</h5>
                            <!--<strong>5245</strong>-->
                    ...
                    <div class="col-sm-6 col-lg-3 mb-3">
                        <div class="card-box" onclick="location.href='{!! route('franchies.team') !!}'">
                            <h5>Team</h5>
                            <!--<strong>20</strong>-->
                    ...
                    <div class="col-sm-6 col-lg-3 mb-3">
                        <div class="card-box" onclick="location.href='{!! route('franchies.zone') !!}'">
                            <h5>Zone</h5>
                            <!--<strong>20</strong>-->
