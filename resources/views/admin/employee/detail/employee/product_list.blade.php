                        ...
                        <div class="table-responsive m-t-10">
                            ...
                            <table id="data-table" class="display nowrap table table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                        ...
                                        <td>
                                            @if($f->team_approvel == 1)
                                                ...
                                                <label class="badge badge-success open-modal"
                                                    ...
                                                    data-toggle="tooltip" data-placement="top" data-restaurant-id="{{ $f->id }}">Approved</label>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.employee.team.view.productEdit' , $f->id) }}" class="btn btn-primary"> <i class="fa fa-edit"></i> </a>
                                        <a href="{{ route('admin.employee.team.view.productDetail' , $f->id) }}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                                @endforeach
