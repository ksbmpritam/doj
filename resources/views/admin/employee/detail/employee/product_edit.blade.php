...
@section('content')
    <div class="page-wrapper">
        ...
        <form action="{{ url ('admin/employee/team/product/update/productUpdate/'.$food->id)}}" method="post" enctype="multipart/form-data">
              @csrf
                        ...
                        <div class="restaurant_payout_create-inner">
                            ...
                            <fieldset>
                              ...
                              <div class="form-group row width-50">
                                ...
                                <div class="col-7">
                                  <input type="number" class="form-control food_price" name="price" value="{{$food->price}}" >
                                  <div class="form-text text-muted">
                                    @if ($errors->has('price'))
                              ...
                              <div class="form-group row width-50">
                                ...
                                <div class="col-7">
                                  <input type="number" class="form-control food_discount" name="discount" value="{{$food->discount}}">
                                  <div class="form-text text-muted">
                            ...
                            <div class="form-group row width-50">
                                <label class="col-3 control-label">Select Partner <sup style="color:red;">*</sup></label>
                                <div class="col-7">
                                    <select id='food_category' class="form-control" name="restaurant_id" required>
                             ...
                             <div class="form-group row width-50">
                              ...
                              <div class="form-group row width-50">
                                ...
                                <div class="col-7">
                                  <input type="number" class="form-control item_quantity" name="item_quantity" value="{{$food->item_quantity}}">
                                  <div class="form-text text-muted">
                            ...
                            <fieldset>
                              ...
                              <div class="form-group row width-50">
                                ...
                                <div class="col-7">
                                  <input type="number" class="form-control food_calories" name="calories" value="{{$food->calories}}">
                                </div>
                              </div>
                              ...
                              <div class="form-group row width-50">
                                ...
                                <div class="col-7">
                                  <input type="number" class="form-control food_grams" name="grams" value="{{$food->grams}}">
                                </div>
                              </div>
                              ...
                              <div class="form-group row width-50">
                                ...
                                <div class="col-7">
                                  <input type="number" class="form-control food_fats" name="fats" value="{{$food->fats}}">
                                </div>
                              </div>
                              ...
                              <div class="form-group row width-50">
                                ...
                                <div class="col-7">
                                  <input type="number" class="form-control food_proteins" name="proteins" value="{{$food->proteins}}">
                                </div>
                              </div>
