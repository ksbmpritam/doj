...
<div class="page-wrapper">
    <form action="{{ url ('admin/employee/team/update/'. $team->id)}}" method="Post" enctype="multipart/form-data">
        @csrf
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                ...
                <li class="breadcrumb-item"><a href="{{url('admin/dashboard')}}">{{trans('lang.dashboard')}}</a></li>
                   <li class="breadcrumb-item"><a href="">Team List</a>
                    </li>
            ...
            <div class="cat-edite-page max-width-box">
                <div class="card  pb-4">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link " href="{{ route('admin.employee.team.teamlist', ['id' => $team_id]) }}"><i class="fa fa-list mr-2"></i>Team List</a>
                            </li>
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                    ...
                    <div class="form-group col-12 text-center btm-btn">
                        ...
                        <a href="{{ route('admin.employee.team.teamlist', ['id' => $team_id]) }}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
                    </div>
