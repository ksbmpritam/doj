...
@section('content')
    <div class="page-wrapper">
        ...
        <form action="{{ url ('admin/franchies/team/restauranteupdate/'.$restaurant->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                                href="{!! route('admin.restaurants.request') !!}">{{trans('lang.restaurant_plural')}}</a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="form-group col-12 text-center btm-btn">
                    <button type="submit" class="btn btn-primary  save_restaurant_btn"><i class="fa fa-save"></i> {{trans('lang.save')}}</button>
                    <a href="{!! route('admin.restaurants.request') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
                </div>
