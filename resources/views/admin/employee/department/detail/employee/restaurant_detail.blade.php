                ...
                <div class="card">
                    <div class="body-card">
                                        ...
                                        <div class="working-hours-container">
                                            ...
                                            @foreach($days as $day)
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12">
                                                        <button type="button" disabled class="btn btn-primary add-working-hours" data-days="{{ $day }}">
                                                            Add
                                                        </button>
                                                    </div>
                                                </div>
                                                            ...
                                                            @foreach($specialOffers[$day] as $offer)
                                                                <div class="mb-2 row">
                                                                    <div class="col-3">
                                                                        ...
                                                                        <input type="time" class="form-control" disabled name="{{ strtolower($day) }}_start_offer[]" value="{{ $offer['opening_time'] }}">
                                                                    </div>
                                                                    <div class="col-3">
                                                                        <label>Closing Time</label>
                                                                        <input type="time" class="form-control" disabled name="{{ strtolower($day) }}_end_offer[]" value="{{ $offer['closing_time'] }}">
                                                                    </div>
                                                                    <div class="col-4">
                                                                        <div class="row">
                                                                            <div class="col-6">
                        ...
                        <div class="form-group col-12 text-center btm-btn">
                            <a href="{!! route('admin.employee.team.restaurant', ['id' =>$restaurant->team_id]) !!}" class="btn btn-default"><i
