...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor orderTitle">Employee </h3>
        </div>
                            ...
                            <table id="data-table" class="display nowrap table table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                   ...
                                   <td class="team-name" data-team-id="{{ $d->team->id ?? '' }}" style="cursor:pointer;" data-team-name="{{ $d->team ? $d->team->name : 'N/A' }}">{{ $d->team ? $d->team->name : 'N/A' }}</td>
                                    ...
                                    <td>  <a href="{{ url('admin/employee/team/teamEdit/' . $d->id) }}" class="btn btn-sm btn-secondary"><i class="fa fa-edit"></i></a>
                                        <a href="{{ url('admin/employee/team/teamDetail/' . $d->id) }}" class="btn btn-sm btn-secondary"><i class="fa fa-eye"></i></a>
