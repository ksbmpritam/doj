                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <ul class="nav nav-tabs align-items-end card-header-tabs justify-content-center w-100">
                                ...
                                <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                    <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-plus mr-2"></i>View Employee</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="restaurant_payout_create-inner">
                                    <fieldset>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" id="mobile_no" readonly onkeypress="return numeralsOnly(event)" maxlength="10" name="mobile_no" value="{{ $employee->mobile_no }}">
                                                <div class="form-text text-muted">
                                                    @error('mobile_no')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" name="password" value="{{ $employee->pwd }}" readonly>
                                        ...
                                        <div class="form-group row width-100">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" id="permanent_address" readonly name="permanent_address" value="{{ $employee->permanent_address }}">
                                                <div class="form-text text-muted">
                                        ...
                                        <div class="form-group row width-100">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" id="communication_address" readonly name="communication_address" @if($employee->address_same == 1) readonly @endif value="{{ $employee->communication_address }}">
                                                <div class="form-text text-muted">
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" id="pan_card_no" name="pan_card_no" value="{{ $employee->pan_card_no }}" readonly>
                                                <div class="form-text text-muted">
                                                    @error('pan_card_no')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" id="aadhar_no" maxlength="12" readonly onkeypress="return numerOnly(event)" name="aadhar_no" value="{{ $employee->aadhar_no }}">
                                                <div class="form-text text-muted">
                                                    @error('aadhar_no')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="form-check row width-100">
                                            <input type="checkbox" class="item_publish" name="status" disabled id="status" value="1" @if($employee->status == 1) checked @endif>
