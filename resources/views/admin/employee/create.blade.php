...
<div class="page-wrapper">
    <form action="{{ url ('admin/employee/insert')}}" method="Post" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <ul class="nav nav-tabs align-items-end card-header-tabs justify-content-center w-100">
                                ...
                                <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                    <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-plus mr-2"></i>Create Employee</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
