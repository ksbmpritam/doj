...
<div class="page-wrapper">
    <form action="{{ route('admin.foodpromoCode.store_users', $promo_code->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.foodpromoCode') }}">Promo Code</a></li>
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                            <li class="nav-item" style="border: 1px solid #ff683a; border-radius: 2px">
                                <a class="nav-link" href="{{ route('admin.foodpromoCode') }}"><i class="fa fa-list mr-2"></i>Promo Code</a>
                            </li>
                            <li class="nav-item" style="border: 1px solid #ff683a; border-radius: 2px">
...
$(document).ready(function () {
    ...
    $.ajax({
        url: '/admin/foodpromoCode/get_users',
        type: 'GET',
        data: {
    ...
    $('#userSearchInput').on('keyup', function () {
        ...
        $('#oldList').empty(); 
        $.ajax({
            url: '/admin/foodpromoCode/search_users',
            type: 'GET',
            data: {
                category: selectedValue,
                search: searchValue,
