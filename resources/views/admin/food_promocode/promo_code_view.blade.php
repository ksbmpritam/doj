    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">View Food Promo Code</h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('admin/dashboard')}}">{{trans('lang.dashboard')}}</a></li>
                    <li class="breadcrumb-item"><a href="{!! route('admin.foodpromoCode.restaurant_list') !!}">Food Promo Code</a></li>
                    <li class="breadcrumb-item active">View Food Promo Code</li>
                </ol>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="cat-edite-page max-width-box">
                <div class="card  pb-4">
                    ...
                    <!--          <a class="nav-link " href="{!! route('admin.foodpromoCode.restaurant_list') !!}"><i class="fa fa-list mr-2" ></i>View Food Promo Code </a>-->
                    <!--        </li>-->
                    <!--        <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">-->
                    <!--          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-plus mr-2" ></i>View Food Promo Code</a>-->
                    <!--        </li>-->
                    <!--    </ul>-->
                    <!--</div>-->
                    <div class="card-body">
                    ...
                    <div class="form-group col-12 text-center btm-btn">
                        ...
                        <a href="{!! route('admin.foodpromoCode.restaurant_list') !!}" class="btn btn-default"><i
