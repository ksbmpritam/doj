...
@section('content')
    <div class="page-wrapper">
        <form action="{{ url('admin/foodpromoCode/update/'. $promo_code->id)}}" method="post" enctype="multipart/form-data">
         @csrf
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Food Promo Code</li>
                </ol>
            </div>
        </div>
                ...
                <div class="card  pb-4">
                    ...
                    <div class="card-header">
                        ...
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                            ...
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                              <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-plus mr-2" ></i>Edit Food Promo Code</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="form-group col-12 text-center btm-btn">
                        ...
                        <a href="{!! route('admin.foodpromoCode') !!}" class="btn btn-default"><i
