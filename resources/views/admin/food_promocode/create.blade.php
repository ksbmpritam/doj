...
<div class="page-wrapper">
    <form action="{{ url ('admin/foodpromoCode/insert')}}" method="Post" enctype="multipart/form-data">
        @csrf
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{!! route('admin.foodpromoCode') !!}">Food Promo Code</a>
                    </li>
                    <li class="breadcrumb-item active">Create Food Promo Code</li>
                </ol>
            </div>
        </div>
                ...
                <div class="card  pb-4">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                            ...
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link active" href="{!! route('admin.foodpromoCode.create') !!}"><i class="fa fa-plus mr-2"></i>Create Food Promo Code</a>
                            </li>
                        </ul>
                    </div>
