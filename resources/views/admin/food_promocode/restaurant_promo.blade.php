                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{$cat->promo_code->promo_code}}
                                             ...
                                             <td>
                                            {{$cat->promo_code->promo_code_name}}
                                        </td>
                                        <td>
                                            {{$cat->restaurant->name}}
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <!--</a>-->
                                            <!--<a href="{{ url('admin/foodpromoCode/restaurant/delete/' . $cat->id) }}" class=" btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="delete" onclick="return confirm('Are you sure you want to delete this promoCode?')"><i class="fa fa-trash"></i> </a>-->
                                            <a href="#" class="btn btn-sm btn-danger"
                                               onclick="showConfirmation('Are you sure you want to delete this promoCode?', function() { window.location.href = '{{ url('admin/foodpromoCode/restaurant/delete/' . $cat->id) }}'; })">
