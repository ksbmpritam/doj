...
<div class="page-wrapper">
    <form action="{{ url('admin/foodpromoCode/store_restaurant/'. $promo_code->id)}}" method="post" enctype="multipart/form-data">
        @csrf
...
$(document).ready(function () {
    ...
    $.ajax({
        url: '/admin/foodpromoCode/get_restaurant',
        type: 'GET',
        data: {
            id: "<?php echo $id ?>"
        },
    ...
    $('#restaurantSearch').on('keyup', function () {
        ...
        showLoader();
          $('#restaurantList').empty();
        $.ajax({
            url: '/admin/foodpromoCode/search_restaurant',
            type: 'GET',
            data: {
                search: searchValue,
                id: "<?php echo $id ?>"
