...
<div class="page-wrapper">
    ...
    <form action="{{ url('admin/gift_card_amount/update/'. $gift->id)}}" method="post" enctype="multipart/form-data">
        @csrf
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row width-50">
                            ...
                            <div class="col-7">
                                ...
                                <input type="text" class="form-control title" name="amount" value="{{ $gift->amount}}" required>
                        ...
                        <div class="form-group row width-100">
                            ...
                            <div class="form-check width-100">
                                ...
                                <input type="checkbox" id="is_publish" value="1" name="status" @if ($gift->status == 1) checked @endif>
