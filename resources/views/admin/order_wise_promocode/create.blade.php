...
<div class="page-wrapper">
    <form action="{{ url ('admin/orderPromoCode/insert')}}" method="Post" enctype="multipart/form-data">
        @csrf
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{!! route('admin.orderPromoCode') !!}">Order Promo Code</a>
                    </li>
                    <li class="breadcrumb-item active">Create Order Promo Code</li>
                </ol>
            </div>
        </div>
                ...
                <div class="card  pb-4">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                            ...
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link active" href="{!! route('admin.orderPromoCode.create') !!}"><i class="fa fa-plus mr-2"></i>Create Order Promo Code</a>
                            </li>
                        </ul>
                    </div>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="category_information">
                                    <fieldset>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" name="promo_code_name" class="form-control" value="{{ old('promo_code_name') }}">
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="number" name="discount" class="form-control" min="0" value="{{ old('discount') }}" pattern="[0-9]*" inputmode="numeric" oninput="validateInput(this);">
                                                <div class="form-text text-muted">
                                                    @error('discount')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="form-group row width-50" >
                                            ...
                                            <div class="col-7">
                                                <input type="number" min="0" name="max_price" class="form-control" value="{{ old('max_price') }}" pattern="[0-9]*" inputmode="numeric" oninput="validateInput(this);">
                                                <div class="form-text text-muted">
                                                    @error('max_price')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="form-group row width-50" >
                                            ...
                                            <div class="col-7">
                                                <input type="number" min="0" name="min_price" class="form-control" value="{{ old('min_price') }}" pattern="[0-9]*" inputmode="numeric" oninput="validateInput(this);">
                                                <div class="form-text text-muted">
                                                    @error('min_price')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="form-group row width-50" >
                                            ...
                                            <div class="col-7">
                                                <select id="count_order" class="form-control" name="count_order">
                                                    <option value="">select type</option>
                                                    <option value="0" {{ old('count_order') == '0' ? 'selected' : '' }}>First Order</option>
                                                    <option value="1" {{ old('count_order') == '1' ? 'selected' : '' }}>Second Order</option>
                                                    <option value="2" {{ old('count_order') == '2' ? 'selected' : '' }}>Third Order</option>
                                                </select>
                                                <div class="form-text text-muted">
                                                    @error('count_order')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="form-group row width-50" >
                                            ...
                                            <div class="col-7">
                                                <input type="number" name="res_percentage" placeholder=" Restaurant" class=" form-control" value="{{ old('res_percentage') }}" pattern="[0-9]*" inputmode="numeric" oninput="validateInput(this);">
                                                <div class="form-text text-muted">
