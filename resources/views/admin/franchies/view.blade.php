...
<div class="page-wrapper">
    <form action="{{ url ('admin/franchies/update/'. $franchise->id)}}" method="Post" enctype="multipart/form-data">
        @csrf
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">View Franchies</h3>
            </div>
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"> View Franchies </li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <ul class="nav nav-tabs align-items-end card-header-tabs justify-content-center w-100">
                                ...
                                <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                    <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-plus mr-2"></i>View Franchies</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="restaurant_payout_create-inner">
                                    <fieldset>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" name="franchies_name" value="{{ $franchise->franchies_name }}" readonly>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" name="franchies_tag_line" value="{{ $franchise->franchies_tag_line }}" readonly>
                                                <div class="form-text text-muted">
                                        ...
                                        <div class="form-group row width-100">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" id="franchies_permanent_address" name="franchies_permanent_address" readonly value="{{ $franchise->franchies_permanent_address }}">
                                                <div class="form-text text-muted">
                                        ...
                                        <div class="form-check row width-100">
                                            <input type="checkbox" class="item_publish" name="franchies_same" disabled id="franchies_same" value="1"  @if($franchise->franchies_same == 1) checked @endif>
                                        ...
                                        <div class="form-group row width-100">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" id="franchies_communication_address" readonly name="franchies_communication_address" @if($franchise->franchies_same == 1) readonly @endif value="{{ $franchise->franchies_communication_address }}">
                                                <div class="form-text text-muted">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" id="mobile_no" readonly onkeypress="return numeralsOnly(event)" maxlength="12" name="mobile_no" value="{{ $franchise->mobile_no }}">
                                                <div class="form-text text-muted">
                                                    @error('mobile_no')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" name="password" value="{{ $franchise->pwd }}" readonly>
                                        ...
                                        <div class="form-group row width-100">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" id="permanent_address" name="permanent_address" value="{{ $franchise->permanent_address }}" readonly>
                                                <div class="form-text text-muted">
                                        ...
                                        <div class="form-check row width-100">
                                            <input type="checkbox" class="item_publish" name="address_same" disabled id="address_same" value="1"
                                        ...
                                        <div class="form-group row width-100">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" id="communication_address" readonly name="communication_address" @if($franchise->communication_address == 1) readonly @endif value="{{ $franchise->communication_address }}">
                                                <div class="form-text text-muted">
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" id="pan_card_no" name="pan_card_no" value="{{ $franchise->pan_card_no }}" readonly>
                                                <div class="form-text text-muted">
                                                    @error('pan_card_no')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" id="aadhar_no" maxlength="12" readonly onkeypress="return numerOnly(event)" name="aadhar_no" value="{{ $franchise->aadhar_no }}">
                                                <div class="form-text text-muted">
                                                    @error('aadhar_no')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="form-check row width-100">
                                            <input type="checkbox" class="item_publish" disabled name="status" id="status" value="1" @if($franchise->status == 1) checked @endif>
