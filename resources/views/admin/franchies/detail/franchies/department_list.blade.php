                        ...
                        <div class="table-responsive m-t-10">
                            ...
                            <table id="data-table" class="display nowrap table table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                                 <a href="{{ url('admin/franchies/department/edit/' . $d->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                        <a href="{{ route('admin.franchies.department.departmentDetail' , $d->id) }}" class="btn btn-sm btn-secondary"><i class="fa fa-eye"></i></a>
