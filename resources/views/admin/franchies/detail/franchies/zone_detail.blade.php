...
<div class="page-wrapper">
    <form action="{{ url ('admin/franchies/department/update/'. $zone->id)}}" method="Post" enctype="multipart/form-data">
        @csrf
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{!! route('franchies.zone') !!}">Department List</a>
                    </li>
                ...
                <div class="card  pb-4">
                     ...
                     <div class="card-body">
                            ...
                            <div class="form-group col-12 text-center btm-btn">
                                ...
                                <a href="{!! route('admin.franchies.department.departmentlist', ['id' => $zone->franchies_id]) !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
