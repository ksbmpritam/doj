    ...
    <form action="{{ url ('team/riders/update/'.$driver->id)}}" method="post" enctype="multipart/form-data">
        ...
        <div class="container-fluid">
                        ...
                        <div class="card-header">
                            <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                                <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                    <a class="nav-link " href="{!! route('admin.franchies.team.rider',['id' => $driver->team_id]) !!}"><i class="fa fa-list mr-2"></i>Rider List </a>
                                </li>
                                <li class="nav-item" style="border: 1px solid #ff683a; border-radius: 2px;">
            ...
            <div class="form-group col-12 text-center btm-btn">
                ...
                <a href="{!! route('admin.franchies.team.rider', ['id' => $driver->team_id]) !!}" class="btn btn-default"><i class="fa fa-undo"></i> Cancel</a> <!-- Updated the text for "Cancel" button -->
            </div>
