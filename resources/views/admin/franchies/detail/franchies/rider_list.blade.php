                                ...
                                <tr>
                                  ...
                                  <td >
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('admin/franchies/team/rider/riderEdit/' . $d->id) }}" class="btn btn-primary btn-sm"> <i class="fa fa-edit"></i> </a>
                                        <a href="{{ url('admin/franchies/team/rider/riderDetail/' . $d->id) }}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
