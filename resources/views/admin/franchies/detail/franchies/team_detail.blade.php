...
<div class="page-wrapper">
        <form action="{{ url ('admin/franchies/team/teamUpdateall/'. $team->id)}}" method="Post" enctype="multipart/form-data">
            ...
            <div class="col-12">
                ...
                <div class="form-group col-12 text-center btm-btn">
                 ...
                 <!--<button type="button" class="btn btn-primary">Update</button>-->
                    ...
                    <a href="{{ route('admin.franchies.team.teamlist',['id' => $team->franchies_id]) }}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
                </div>
            </div>
        </div>
    </div>
