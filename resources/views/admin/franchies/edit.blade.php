                                ...
                                <div class="restaurant_payout_create-inner">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" id="mobile_no" onkeypress="return numeralsOnly(event)" maxlength="10" name="mobile_no" value="{{ $franchise->mobile_no }}">
                                                <div class="form-text text-muted">
                                                    @error('mobile_no')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <select class="form-control" id="zone_id" name="zone_id">
                                                    ...
                                                    @foreach($zone as $zon)
                                                         <option value="{{ $zon->id }}" {{ old('zone_id', $franchise->zone_id) == $zon->id ? 'selected' : '' }}>
                                                            {{ $zon->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
