                                  ...
                                  @foreach($franchise as $fran)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('admin/franchies/view/' . $fran->id) }}" class="btn btn-sm btn-secondary"><i class="fa fa-eye"></i></a>
                                            ...
                                            <a href="#" class="btn btn-sm btn-danger"
                                               onclick="showConfirmation('Are you sure you want to delete this Franchies ?', function() { window.location.href = '{{ url('admin/franchies/delete/' . $fran->id) }}'; })">
