    ...
    <div>
      ...
      <div class="card-body">
          ...
          <div class="restaurant_payout_create-inner">
            ...
            <fieldset>
              ...
              <div class="form-group row width-50">
                <label class="col-3 control-label">{{trans('lang.food_name')}} <sup style="color:red;">*</sup></label>
                <div class="col-7">
              ...
              <div class="form-group row width-50">
                <label class="col-3 control-label">{{trans('lang.food_price')}} <sup style="color:red;">*</sup></label>
                <div class="col-7">
                  <input type="number" class="form-control food_price" name="price" pattern="[0-9]*" inputmode="numeric" oninput="validateInput(this);">
                  <div class="form-text text-muted">
                    @if ($errors->has('price'))
              ...
              <div class="form-group row width-50">
                <label class="col-3 control-label">{{trans('lang.food_discount')}} <sup style="color:red;">*</sup></label>
                <div class="col-7">
                  <input type="number" class="form-control food_discount" max="100" pattern="[0-9]*" inputmode="numeric" oninput="validateInput(this);" name="discount" >
                  <div class="form-text text-muted">
              ...
              <?php if ($id == '') { ?>
                <div class="form-group row width-50">
                  <label class="col-3 control-label">Partner <sup style="color:red;">*</sup></label>
                  <div class="col-7">
                    <select id="food_restaurant" class="form-control" name="restaurant_id">
                    ...
                    <div class="form-text text-muted">
                       @if ($errors->has('restaurant_id'))
                            <div class="text-danger">{{ $errors->first('restaurant_id') }}</div>
                        @endif
                    </div>
                  </div>
                </div>
              ...
              <div class="form-group row width-50">
                <label class="col-3 control-label">{{trans('lang.food_category_id')}} <sup style="color:red;">*</sup></label>
                <div class="col-7">
              ...
              <div class="form-group row width-50">
                <label class="col-3 control-label">{{trans('lang.item_quantity')}} <sup style="color:red;">*</sup></label>
                <div class="col-7">
                  <input type="number" class="form-control item_quantity" pattern="[0-9]*" inputmode="numeric" oninput="validateInput(this);" name="item_quantity" >
                  <div class="form-text text-muted">
            ...
            <fieldset>
              ...
              <div class="form-group row width-50">
                <label class="col-3 control-label">{{trans('lang.calories')}} <sup style="color:red;">*</sup></label>
                <div class="col-7">
                  <input type="number" class="form-control food_calories" name="calories" oninput="validateInput2(this);">
                   <div class="form-text text-muted">
              ...
              <div class="form-group row width-50">
                <label class="col-3 control-label">{{trans('lang.grams')}} <sup style="color:red;">*</sup></label>
                <div class="col-7">
                  <input type="number" class="form-control food_grams" name="grams" oninput="validateInput2(this);">
                  <div class="form-text text-muted">
                     @if ($errors->has('grams'))
              ...
              <div class="form-group row width-50">
                <label class="col-3 control-label">{{trans('lang.fats')}} <sup style="color:red;">*</sup></label>
                <div class="col-7">
                  <input type="number" class="form-control food_fats" name="fats" oninput="validateInput2(this);">
                  <div class="form-text text-muted">
                     @if ($errors->has('fats'))
              ...
              <div class="form-group row width-50">
                <label class="col-3 control-label">{{trans('lang.proteins')}} <sup style="color:red;">*</sup></label>
                <div class="col-7">
                  <input type="number" class="form-control food_proteins" name="proteins" oninput="validateInput2(this);">
                  <div class="form-text text-muted">
            ...
            <div class="form-group row width-100" id="add_size_div" style="display:none">
              <div class="row">
                <div class="col-6">
                  ...
                  <div class="col-7">
                    <input type="text" class="form-control add_size_title" name="food_size">
                  </div>
                </div>
                <div class="col-6">
                  <label class="col-3 control-label">{{trans('lang.food_price')}}</label>
                  <div class="col-7">
                    <input type="number" class="form-control add_size_price" name="food_price">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="form-group col-12 text-center btm-btn">
            ...
            <a href="{!! route('admin.products') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
        </div>
      </div>
    </div>
  </form>
                ...
                let specificationRow = `
                    <div class="mb-2 row">
                        <div class="col-5">
                            ...
                            <input type="text" class="form-control" name="specifications_label[]">
                        </div>
                        <div class="col-5">
                            <label class="col-2 control-label">{{trans('lang.value')}}</label>
                            <input type="text" class="form-control" name="specifications_value[]">
                        </div>
                        <div class="col-2">
...
<script>
    function validateInput2(element) {
        element.value = element.value.replace(/[^0-9.]/g, '');
        var dotCount = (element.value.match(/\./g) || []).length;
        if (dotCount > 1) {
