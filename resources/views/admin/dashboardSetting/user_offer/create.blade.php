...
<div class="page-wrapper">
    <form action="{{ url ('admin/users/offer/insert')}}" method="Post" enctype="multipart/form-data">
        @csrf
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{!! route('admin.users.offer') !!}"> User Offer </a>
                    </li>
                    <li class="breadcrumb-item active">Create User Offer</li>
                </ol>
            </div>
        </div>
            ...
            <div class="cat-edite-page max-width-box">
                <div class="card  pb-4">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link " href="{!! route('admin.users.offer') !!}"><i class="fa fa-list mr-2"></i>User Offer</a>
                            </li>
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link active" href="{!! route('admin.users.offer.create') !!}"><i class="fa fa-plus mr-2"></i>Create User Offer</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="row restaurant_payout_create" role="tabpanel">
                            ...
                            <div class="restaurant_payout_create-inner tab-content">
                                <div role="tabpanel" class="tab-pane active" id="category_information">
                                    <fieldset>
                                        <legend>Create User Offer</legend>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <input type="date" id="opening_date" name="opening_date" class="col-7 form-control" value="{{ old('opening_date') }}">
                                            <div class="form-text text-muted">
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <input type="date" id="closing_date" name="closing_date" class="col-7 form-control" value="{{ old('closing_date') }}">
                                            <div class="form-text text-muted">
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <input type="time" id="opening_time" name="opening_time" class="col-7 form-control" value="{{ old('opening_time') }}">
                                            <div class="form-text text-muted">
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <input type="time" id="closing_time" name="closing_time" class="col-7 form-control" value="{{ old('closing_time') }}">
                                            <div class="form-text text-muted">
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="number" name="discount" class="form-control" min="0" value="{{ old('discount') }}">
                                                <div class="form-text text-muted">
                                                    @error('discount')
                                        ...
                                        <div class=" row width-100">
                                            <label class="col-3 control-label">Users <sup style="color:red;">*</sup>
                                             <div class="form-text text-muted">
                                                @error('user_id')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            @if($users)
                                                @foreach($users as $user)
                                                    <div class="form-check">
                                                        <input type="radio" class="item_publish" name="user_id" value="{{ $user->id }}" id="{{ $user->id }}"
                                        ...
                                        @if($foods)
                                            @foreach($foods as $food)
                                                <div class="form-check">
                                                    <input type="checkbox" class="item_publish" name="food_id[]" value="{{ $food->id }}" id="f_{{ $food->id }}"
                                                        {{ in_array($food->id, old('food_id', [])) ? 'checked' : '' }}>
                    ...
                    <div class="form-group col-12 text-center btm-btn">
                        ...
                        <a href="{!! route('admin.users.offer') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
                    </div>
