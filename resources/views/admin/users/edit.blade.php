          ...
          <div class="restaurant_payout_create-inner">
            <fieldset>
              ...
              <div class="form-group row width-50">
                ...
                <div class="col-7">
                  <input type="email" class="form-control user_email" name="email" value="{{$user->email}}">
                  <div class="form-text text-muted">
              ...
              <div class="form-group row width-50">
                ...
                <div class="col-7">
                  <input type="text" class="form-control user_phone" name="mobile_number" value="{{$user->mobile_number}}" maxlength="12" onkeypress="return numeralsOnly(event)">
              ...
              <div class="form-group row">
                ...
                <div class="form-group row width-50">
                  <div class="form-check width-100">
                    <input type="checkbox" class="user_active" value="1" id="user_status" name="status" @if ($user->status == 1) checked @endif>
            ...
            <fieldset>
              ...
              <div class="form-group row width-50">
                ...
                <div class="col-7">
                  <input type="text" class="form-control user_latitude" name="latitude" value="{{$user->latitude}}">
                  <div class="form-text text-muted w-100">
              ...
              <div class="form-group row width-50">
                ...
                <div class="col-7">
                  <input type="text" class="form-control user_longitude" name="longitude" value="{{$user->longitude}}">
                  <div class="form-text text-muted w-100">
