    ...
    <div class="page-wrapper">
        ...
        <div class="card-body">
            ...
            <div class="menu-tab">
                <ul>
                    <li >
                        <a href="{{route('admin.users.view',$orders->users->id)}}">{{trans('lang.tab_basic')}}</a>
                    </li>
                    <li class="active">
                        <a href="{{route('admin.users.orders',$orders->users->id)}}">{{trans('lang.tab_orders')}}</a>
                    </li>
                    <li>
                        <a href="{{route('admin.users.payout',$orders->users->id)}}">Wallet Transaction</a>
                    </li>
                </ul>
            </div>
            <div class="text-right print-btn">
                <a href="">
                    <a href="{{ url('admin/users/order/pdf/'.$id) }}"  class="btn btn-sm btn-primary"> <i class="fa fa-print"></i> </a>
                </a>
            </div>
        ...
        <div class="form-group col-12 text-center btm-btn">
            ...
            <a href="{!! url('admin/users/orders',$orders->users->id) !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}
            </a>
