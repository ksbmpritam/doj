            ...
            <div class="cat-edite-page max-width-box">
                <div class="card  pb-4">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="category_information">
                                    <fieldset>
                                        ...
                                        <div class="form-group row width-100">
                                            ...
                                            <div class="col-7">
                                                <input type="file" id="slider_images" name="slider_images">
                                                <div class="placeholder_img_thumb cat_image"></div>
                                                <div id="uploding_image">
                                                    <img src="{{ asset('images/slider/' . $sliders->image) }}" width="100" height="100" alt="type Photo">
                                                </div>
                                       ...
                                       <div class="form-check row width-100">
                                            <input type="checkbox" id="item_publish" value="1" name="status" @if ($sliders->status == 1) checked @endif>
                                        ...
                                        <!--    <input type="checkbox" name="show_in_homepage" value="1" id="show_in_homepage" @if ($sliders->homepage == 1) checked @endif>-->
                    ...
                    <div class="form-group col-12 text-center btm-btn">
                        ...
                        <a href="{!! route('admin.slider') !!}" class="btn btn-default">
