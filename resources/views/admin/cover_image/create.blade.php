...
@section('content')
  ...
  <div class="page-wrapper">
      ...
      <form action="{{ url('admin/cover_image/insert')}}" method="post" enctype="multipart/form-data">
         @csrf
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Create Cover Image</li>
    ...
    <div class="card-body">
        ...
        <div id="data-table_processing" class="dataTables_processing panel panel-default" style="display: none;">Cover Image</div>
