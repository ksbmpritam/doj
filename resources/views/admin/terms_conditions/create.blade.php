...
<div class="page-wrapper">
    <form action="{{ url ('admin/termsAndConditions/insert')}}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Create Terms and Conditions</li>
                </ol>
            </div>
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link " href="{!! route('admin.termsAndConditions') !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.terms_and_conditions')}}</a>
                            </li>
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link active" href="{!! route('admin.termsAndConditions.create') !!}"><i class="fa fa-plus mr-2"></i>Create Terms & Conditions</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
