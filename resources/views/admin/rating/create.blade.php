...
@section('content')
  ...
  <div class="page-wrapper">
      ...
      <form action="{{ url('admin/rating/insert')}}" method="post" enctype="multipart/form-data">
         @csrf
    ...
    <div class="card-body">
        ...
        <div id="data-table_processing" class="dataTables_processing panel panel-default" style="display: none;">Rating</div>
            ...
            <div class="restaurant_payout_create-inner">
                ...
                <fieldset>
                    ...
                    <div class="form-group row width-50">
                        ...
                        <div class="col-7">
                            <input type="number" class="form-control title" min="0" max="5" name="value" required>
                            @error('value')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
