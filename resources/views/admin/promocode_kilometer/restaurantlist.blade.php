...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">Restaurant kilometer Promo Codes</h3>
        </div>
                          ...
                          <span title="{{ $promo_code_name}}">{{ $promo_code_name }}</span>
                               ...
                               NA (ID: {{ $promo_code_name }})
                                @endif
                                        ...
                                        <td>{{ $cat->restaurant->name }}</td>
                                        <td>{{ $cat->restaurant->mobile_no }}</td>
                                        <td>
                                            @if ($cat->accept_by == 1)
                                        ...
                                        <td>
                                            ...
                                            <!-- Example of edit and delete links (update URLs accordingly) -->
                                            ...
                                            <!--</a>-->
                                            <a href="{{ url('admin/kilometer/restaurantDelete/' . $cat->id) }}" class="btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" onclick="return confirm('Are you sure you want to delete this promoCode?')">
