...
<div class="page-wrapper">
 <form action="{{ url ('admin/kilometer/insert')}}" method="Post" enctype="multipart/form-data">
        @csrf
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{!! route('admin.kilometer') !!}">Promo Code</a>
                    </li>
            ...
            <div class="cat-edite-page max-width-box">
                <div class="card  pb-4">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link " href="{!! route('admin.kilometer') !!}"><i class="fa fa-list mr-2"></i>Promo Code kilometer  List</a>
                            </li>
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link active" href=""><i class="fa fa-plus mr-2"></i>Create Promo Code</a>
                            </li>
                        </ul>
                    </div>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="category_information">
                                    <fieldset>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                              <input type="text" name="kilometter" placeholder="Enter Kilometer" pattern="[0-9]*" inputmode="numeric" oninput="validateInput(this);" class="col-sm-5 form-control" />
                                                <div class="form-text text-muted">
                                                    @error('kilometter')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                         ...
                                         <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                              <input type="number" name="minimum" placeholder="Enter minimum Amount " pattern="[0-9]*" inputmode="numeric" oninput="validateInput(this);" class="col-sm-5 form-control" />
                                                <div class="form-text text-muted">
                                                    @error('minimum')
                                                    <span class="text-danger">{{$message }}</span>
                                                    @enderror
                                         ...
                                         <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                              <input type="number" name="maximum" placeholder="Enter Maximum  Amount  "  pattern="[0-9]*" inputmode="numeric" oninput="validateInput(this);" class="col-sm-5 form-control" />
                                                <div class="form-text text-muted">
                                                    @error('maximum')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="number" name="discount" class="form-control" min="0" pattern="[0-9]*" inputmode="numeric" oninput="validateInput(this);" value="{{ old('discount') }}">
                                                <div class="form-text text-muted">
                                                    @error('discount')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                    ...
                    <div class="form-group col-12 text-center btm-btn">
                        ...
                        <a href="{{url('/admin/kilometer')}}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
                    </div>
