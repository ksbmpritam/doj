...
<div class="page-wrapper">
    ...
    <form action="{{ url('admin/gift_card_order/update/'. $order->id)}}" method="post" enctype="multipart/form-data">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">View Gift Amount</li>
                ...
                <div class="restaurant_payout_create-inner">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row width-50">
                            ...
                            <label class="col-3 control-label">Code</label>
                        ...
                        <div class="form-group row width-50">
                            <label class="col-3 control-label">Expiration Date</label>
                            <div class="col-7">
                                @php
                        ...
                        <div class="form-group row width-50">
                            ...
                            <label class="col-3 control-label" >Redeemed Date</label>
                        ...
                        <div class="form-group row width-50">
                            ...
                            <label class="col-3 control-label">Select type</label>
                        ...
                        <div class="form-group row width-50">
                            ...
                            <label class="col-3 control-label">Value</label>
        ...
        <div class="form-group col-12 text-center">
            <a href="{{ url('admin/gift_card_order') }}" class="btn btn-danger"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
