            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs justify-content-center w-100">
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-list mr-2"></i>Attributes List</a>
                            </li>
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link" href="{!! route('admin.attributes.create') !!}"><i class="fa fa-plus mr-2"></i>Create Attributes</a>
                            </li>
                        </ul>
                    </div>
                    @if(session('error'))
                    ...
                    <div class="card-body">
                        ...
                        <!--<form action="{{ url ('admin/attributes')}}" method="get" enctype="multipart/form-data">-->
                        ...
                        <!--                    {{trans('lang.search')}}-->
                        <!--                </button>-->
                        <!--                <a href="{{ url ('admin/attributes')}}" class="btn btn-warning btn-flat">{{trans('lang.clear')}}</a>-->
                                ...
                                <tbody >
                                    @foreach ($attributes as $attribute_data)
                                        <tr>
                                            ...
                                            <td >
                                                <a href="{{ url('admin/attributes/edit/' . $attribute_data->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                                <!--<a href="{{ url('admin/attributes/delete/' . $attribute_data->id) }}"  onclick="return confirm('Are you sure you want to delete this Attribute ?')" class="btn btn-danger"><i class="fa fa-trash"></i></a>-->
                                                <a href="#" class="btn btn-sm btn-danger"
                                                   onclick="showConfirmation('Are you sure you want to delete this Attribute?', function() { window.location.href = '{{ url('admin/attributes/delete/' . $attribute_data->id) }}'; })">
