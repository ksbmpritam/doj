        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{!! route('admin.promoCode.restaurant_list') !!}">Promo Code</a></li>
            ...
            <div class="cat-edite-page max-width-box">
                <div class="card  pb-4">
                    ...
                    <div class="card-header">
                        ...
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                              <a class="nav-link " href="{!! route('admin.promoCode.restaurant_list') !!}"><i class="fa fa-list mr-2" ></i>Promo Code </a>
                            </li>
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                              <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-plus mr-2" ></i>View Promo Code</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="promo_information">
                                    <fieldset>
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" name="promo_code" class="form-control" value="{{$promo_code->promo_code}}">
                    ...
                    <div class="form-group col-12 text-center btm-btn">
                        ...
                        <a href="{!! route('admin.promoCode.restaurant_list') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
                    </div>
