...
@section('content')
    <div class="page-wrapper">
        <form action="{{ url ('admin/slider_category/update/'.$slider_category->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a
                                    href="{!! route('admin.slider_category') !!}">Slide Category</a></li>
                        <li class="breadcrumb-item active">Edit Slide Category</li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="restaurant_payout_create-inner">
                        <fieldset>
                            ...
                            <div class="form-group row width-100">
                                ...
                                <div class="col-7">
                                    <input type="text" class="form-control attribute-name" name="title" value="{{ $slider_category->title }}">
                            ...
                            <div class="form-check row width-100">
                                <input type="checkbox" class="item_publish" name="status" id="item_publish" value="1" @if($slider_category->status == 1) checked @endif>
