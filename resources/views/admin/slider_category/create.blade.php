...
@section('content')
    <div class="page-wrapper">
          <form action="{{ url ('admin/slider_category/insert')}}" method="Post" enctype="multipart/form-data">
            @csrf
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{!! route('admin.slider_category') !!}">Slide Category</a></li>
                    <li class="breadcrumb-item active">Create Slide Category</li>
                </ol>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="row restaurant_payout_create">
                ...
                <div class="restaurant_payout_create-inner">
                    <fieldset>
                        <legend>Create Slide Category</legend>
