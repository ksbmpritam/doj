...
<div class="page-wrapper">
    <form action="{{ url ('admin/restaurants/request/update/'.$restaurant->id)}}" method="post" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card">
                    <div class="body-card">
                        ...
                        <div class="form-group col-12 text-center btm-btn">
                            ...
                            <a href="{!! route('admin.restaurants.request') !!}" class="btn btn-default">
