                        ...
                        <div class="table-responsive m-t-10">
                            ...
                            <table id="data-table" class="display  table table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('admin/rider/request/edit/' . $d->id) }}" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Edit"> <i class="fa fa-edit"></i> </a>
                                        <a href="{{ url('admin/rider/request/view/' . $d->id) }}" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
