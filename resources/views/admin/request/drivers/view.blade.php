...
<div class="page-wrapper">
    <form action="{{ url ('admin/drivers/request/update/'.$driver->id)}}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="container-fluid">
                        ...
                        <div class="card-header">
                            <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                                <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                    <a class="nav-link " href="{!! route('admin.rider.request') !!}"><i class="fa fa-list mr-2"></i>Rider List </a>
                                </li>
                                <li class="nav-item" style="border: 1px solid #ff683a; border-radius: 2px;">
            ...
            <div class="form-group col-12 text-center btm-btn">
                ...
                <a href="{!! route('admin.rider.request') !!}" class="btn btn-default"><i class="fa fa-undo"></i> Cancel</a>
            </div>
