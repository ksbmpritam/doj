                        ...
                        <div class="table-responsive m-t-10">
                            ...
                            <table id="data-table" class="display nowrap table table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.product.request.edit' , $f->id) }}" class="btn btn-primary btn-sm"> <i class="fa fa-edit"></i> </a>
                                        <a href="{{ route('admin.product.request.view' , $f->id) }}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                                @endforeach
...
<script>
    $(document).ready(function () {
        $('.open-modal').on('click', function () {
            ...
            $.ajax({
                url: '/admin/product/request/' + restaurantId,
                type: 'GET',
