    ...
    <div class="page-wrapper">
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{!! route('admin.orders') !!}">{{trans('lang.order_plural')}}</a></li>
        ...
        <div class="card-body">
            ...
            <div class="text-right print-btn">
                <a href="">
                   <a href="{{ url('admin/orders/pdf/'.$orders->id) }}"  class="btn btn-sm btn-primary"> <i class="fa fa-print"></i> </a>
                </a>
            </div>
                            ...
                            <div class="order_detail-top-box bg-light">
                                <div class="form-group row widt-100 gendetail-col payment_method">
                                    <label class="col-12 control-label">
                                        ...
                                        <span id="payment_method">{{$orders->order_id}}</span>
                                    </label>
                                </div>
                                ...
                                <div class="form-group row widt-100 gendetail-col payment_method">
                                    <label class="col-12 control-label">
                                        ...
                                        <span id="payment_method">{{$orders->type}}</span>
                                    </label>
                                </div>
                                <div class="form-group row widt-100 gendetail-col payment_method">
                                    <label class="col-12 control-label">
                                        <strong>{{trans('lang.payment_status')}}:</strong>
                                        <span id="payment_method">{{$orders->code}}</span>
                                    </label>
                                </div>
                                <div class="form-group row widt-100 gendetail-col payment_method">
                                    <label class="col-12 control-label">
                                        <strong>Transaction Id:</strong>
                                        <span id="payment_method">{{$orders->transactionId}}</span>
                                    </label>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <table cellpadding="0" cellspacing="0"
                                            ...
                                            <tbody id="order_products">
                                                @if($foodDetails)
                                                    @foreach($foodDetails as $item_data)
                                                        <tr>
                                                            <td>
                                    ...
                                    <div class="rental-review col-md-12">
                                        <div class="review-inner">
                                            ...
                                            <div id="customers_rating_and_review">
                                                ...
                                                @if($orders->foodreviews)
                                                    @foreach($orders->foodreviews as $reviews)
                                                        <tr class="w-100">
                                                    ...
                                                    @endforeach
                                                @endif
                                                @if($orders->resturantreviews)
                                                    @foreach($orders->resturantreviews as $reviews)
                                                        <tr>
        ...
        <div class="form-group col-12 text-center btm-btn">
            ...
            <a href="{{route('admin.restaurants.orders',$_GET['eid'])}}" class="btn btn-default"><i
                        class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
            <?php }else{ ?>
            <a href="{!! route('admin.orders') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}
            </a>
        <?php } ?>
