            ...
            <div class="col-12">
                ...
                <div class="menu-tab vendorMenuTab">
                    <ul>
                        ...
                        <li class="active">
                            <a href="{{route('admin.drivers.orders',$id)}}">{{trans('lang.tab_orders')}}</a>
                        </li>
                        <!--<li>-->
                            ...
                            <table id="data-table" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('admin/drivers/orders/edit/' . $order_data->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i> </a>
                                            <a href="{{ url('admin/orders/delete/' . $order_data->id) }}" class="btn btn-danger"><i class="fa fa-trash"></i> </a>
                                        </td>
                                    </tr>
                                    @endforeach
