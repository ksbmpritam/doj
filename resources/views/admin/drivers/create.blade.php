...
<div class="page-wrapper">
    <form action="{{ url ('admin/drivers/insert')}}" method="post" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card  pb-4">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                            ...
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link active" href="{!! route('admin.drivers.create') !!}"><i class="fa fa-plus mr-2"></i>Create {{trans('lang.driver_plural')}}</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row restaurant_payout_create">
                            <div class="restaurant_payout_create-inner">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row">
                                        <div class="form-group row width-50">
                                            <label class="col-3 control-label">Aadhar Number <sup style="color:red;">*</sup></label>
                                            <div class="col-7">
                                        ...
                                        <div class="form-group row width-50">
                                            <label class="col-3 control-label">PAN Number <sup style="color:red;">*</sup></label>
                                            <div class="col-7">
                            ...
                            <div class="form-group col-12 text-center btm-btn">
                                ...
                                <a href="{!! route('admin.drivers') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{ trans('lang.cancel')}}</a>
                            </div>
                        </div>
