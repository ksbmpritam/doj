...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-5 align-self-center">
            ...
            <h3 class="text-themecolor">Offer</h3>
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                            ...
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link" href="{!! route('admin.offer.create') !!}"><i class="fa fa-plus mr-2"></i>Create Offer</a>
                            </li>
                        </ul>
                    </div>
                    @if(session('error'))
                    ...
                    <div class="table-responsive m-t-10">
                        ...
                        <table id="data-table" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('images/offer/' . $cat->image) }}" width="100" height="100" alt="offer Photo">
                                </td>
                                <td>
                                    @if ($cat->status == 1 )
                                ...
                                <td>
                                    <a href="{{ url('admin/offer/edit/' . $cat->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                    <!--<a href="{{ url('admin/offer/delete/' . $cat->id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this Offer ?')"><i class="fa fa-trash"></i></a>-->
                                    <a href="#" class="btn btn-sm btn-danger"
                                       onclick="showConfirmation('Are you sure you want to delete this Offer?', function() { window.location.href = '{{ url('admin/offer/delete/' . $cat->id) }}'; })">
