            ...
            <div class="col-12">
                 ...
                 <div class="menu-tab vendorMenuTab">
                    <ul>
                        ...
                        <!--</li>-->
                        <li class="active">
                            <a href="{{route('team.orders')}}">{{trans('lang.tab_orders')}}</a>
                        </li>
                        <!--<li>-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!--<form action="{{ url ('team/orders')}}" method="get" enctype="multipart/form-data">-->
                            ...
                            <!--        <a href="{{ url ('team/orders')}}" class="btn btn-warning btn-flat"> <i class="fa fa-refresh"></i></a>-->
                            <!--    </div>-->
                            <!--</div>-->
                            <!--</form>-->
                                    ...
                                    <tbody >
                                        @foreach($orders as $order_data)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('team/orders/edit/' . $order_data->id) }}" class="btn btn-sm btn-primary btn-sm"><i class="fa fa-eye"></i></a>
                                                    <a href="{{ url('team/orders/delete/' . $order_data->id) }}" onclick="return confirm('Are You Sure Wants to delete this order ?');" class="btn btn-sm btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
