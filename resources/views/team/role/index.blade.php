                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                            ...
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link" href="{!! route('employee.role.create') !!}"><i class="fa fa-plus mr-2"></i>Create Role</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="table-responsive m-t-10">
                            ...
                            <table id="data-table2" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('employee/role/edit/' . $d->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                        <a href="{{ url('employee/role/delete/' . $d->id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this role ?')"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
