...
<div class="page-wrapper">
  <form action="{{ url ('team/products/insert')}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row page-titles">
      ...
      <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="{!! route('team.dashboard') !!}">{{trans('lang.dashboard')}}</a></li>

          <li class="breadcrumb-item"><a href="{!! route('team.products') !!}">Products</a></li>
          ...
          <div class="restaurant_payout_create-inner">
            ...
            <fieldset>
              ...
              <div class="form-group row width-50">
                ...
                <div class="col-7">
                  <input type="number" class="form-control item_quantity" name="item_quantity" >
                  <div class="form-text text-muted">
