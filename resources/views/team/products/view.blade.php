...
@section('content')
    <div class="page-wrapper">
        <form action="{{ url ('team/products/update/'.$food->id)}}" method="post" enctype="multipart/form-data">
              @csrf
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{!! route('team.products') !!}">Product</a></li>
            ...
            <div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group col-12 text-center btm-btn">
                        ...
                        <a href="{!! route('team.products') !!}" class="btn btn-default"><i class="fa fa-undo"></i>{{trans('lang.cancel')}}</a>
