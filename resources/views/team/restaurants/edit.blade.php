...
@section('content')
    <div class="page-wrapper">
        <form action="{{ url ('team/restaurants/update/'.$restaurant->id)}}" method="post" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="restaurant_payout_create-inner">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row width-100">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control" id="permanent_address" name="permanent_address" value="{{ $restaurant->permanent_address }}">
                                                <div class="form-text text-muted">
