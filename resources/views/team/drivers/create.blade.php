...
<div class="page-wrapper">
    <form action="{{ url ('team/riders/insert')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Create {{trans('lang.driver_plural')}}</li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100  justify-content-center">
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link " href="{!! route('team.riders') !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.driver_plural')}} List </a>
                            </li>
                            <li class="nav-item" style="border: 1px solid #ff683a;border-radius:2px">
                                <a class="nav-link active" href="{!! route('team.riders.create') !!}"><i class="fa fa-plus mr-2"></i>Create {{trans('lang.driver_plural')}}</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="restaurant_payout_create-inner">
                                <fieldset>
                                    ...
                                    <div class="form-group row width-50">
                                        ...
                                        <div class="col-7">
                                            <input type="number" class="form-control" name="latitude" step="any" value="{{ old('latitude') }}">
                                    ...
                                    <div class="form-group row width-50">
                                        ...
                                        <div class="col-7">
                                            <input type="number" class="form-control" name="longitude" step="any" value="{{ old('longitude') }}">
                                    ...
                                    <div class="form-group row width-50">
                                        ...
                                        <div class="col-7">
                                            <input type="text" class="form-control" name="work_area" value="{{ old('work_area') }}">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row">
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="number" class="form-control @error('aadhar_no') is-invalid @enderror" name="aadhar_no" value="{{ old('aadhar_no') }}">
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="file" class="" name="aadhar_image">
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="col-7">
                                                <input type="text" class="form-control @error('pan_card_no') is-invalid @enderror" name="pan_card_no" value="{{ old('pan_card_no') }}">
                                                <small class="form-text text-muted">
                                                    @error('pan_card_no')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row width-50">
                                        ...
                                        <div class="col-12">
                                            <input type="text" id="branch_name" name="branch_name" class="form-control" value="{{ old('branch_name') }}" required>
                                            <small class="form-text text-muted">
                                                @error('branch_name')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                    ...
                                    <div class="form-group row width-50">
                                        <label for="account_number" class="col-3 control-label">{{ trans('Account Number') }}</label>
                                        <div class="col-12">
                                            <input type="text" id="account_number" name="account_number" class="form-control" value="{{ old('account_number') }}" required>
                                            <small class="form-text text-muted">
                                        ...
                                        <label for="holder_name" class="col-3 control-label">{{ trans('Holder Name') }}</label>
                                        <div class="col-12">
                                            <input type="text" id="holder_name" name="holder_name" class="form-control" value="{{ old('holder_name') }}" required>
                                            <small class="form-text text-muted">
                                                    @error('holder_name')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                    ...
                                    {{-- IFSC Code --}}
                                    <div class="form-group row width-50">
                                        <label for="ifsc_code" class="col-3 control-label">{{ trans('IFSC Code') }}</label>
                                        <div class="col-12">
                                            <input type="text" id="ifsc_code" name="ifsc_code" class="form-control" value="{{ old('ifsc_code') }}" required>
                                            <small class="form-text text-muted">
                                                @error('ifsc_code')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                    ...
                                    {{-- Other Information --}}
                                    <div class="form-group row width-100">
                                        <label for="other_information" class="col-3 control-label">{{ trans('Other Information') }}</label>
                                        <div class="col-12">
                                            <textarea id="other_information" name="other_information" value="{{ old('other_information') }}" class="form-control" rows="4"></textarea>
                                            <small class="form-text text-muted">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row">
                                        <div class="form-check width-100">
                                            <input type="checkbox" class="col-7 form-check-inline" value="1" id="user_active" name="available">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row width-50">
                                        ...
                                        <div class="col-7">
                                            <input type="text" class="form-control car_name" name="car_name" value="{{ old('car_name') }}">
